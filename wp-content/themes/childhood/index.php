            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('team_photo');?>" alt="наша команда">    <!--<?=bloginfo('template_url');?>/assets/img/team.jpg-->
                    </div>
                </div>
            </div>
        </div>
...
<?php 
    ...
    // do_action('my_hook', 'dear customer', 'Sergey');

    // function my_filter_function($str) {
    //     return '<br/>Hello ' . $str . '<br/>';
    // }
