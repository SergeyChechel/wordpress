!function (i) {
    ...
    i.r(e);
    i(1);
    var o = i(2), n = i(4), r = i(7), s = i(9), a = i(10), l = i(11);
    ...
    e.default = function () {
        ...
        try {
            e(".newsslider"), t(new n.a(".newsslider", {
                ...
                breakpoints: {769: {perView: 2}, 576: {perView: 1}}
    ...
    r = function () {
        ...
        var _ = (t(f, [{
            key: "on", value: function (t, e) {
                if (h(t)) for (var i = 0; i < t.length; i++) this.on(t[i], e);
            ...
            key: "emit", value: function (t, e) {
                if (h(t)) for (var i = 0; i < t.length; i++) this.emit(t[i], e);
        ...
        function b(i, o, n) {
            var r = void 0, s = void 0, a = void 0, l = void 0, u = 0;
            n = n || {};
        ...
        var v = {ltr: ["marginLeft", "marginRight"], rtl: ["marginRight", "marginLeft"]};
        ...
        var T = P, G = ["touchstart", "mousedown"], A = ["touchmove", "mousemove"],
        ...
        var B = {
            Html: function (e, t) {
                    ...
                    set: function (t) {
                        var e = function (o, n, r) {
                            var s = [function (e, i) {
                                ...
                                return {
                                    modify: function (t) {
                                        var e = s.Gaps.value, i = s.Sizes.width, o = r.settings.focusAt,
                ...
                return s.on("move", function (t) {
                    var e = r.Gaps.value, i = r.Sizes.length, o = r.Sizes.slideWidth;
                ...
                return d(o, "value", {
                    ...
                    get: function () {
                        var t = o.value, e = i.settings.perView;
                ...
                var i = {
                    apply: function (t) {
                        for (var e = 0, i = t.length; e < i; e++) {
                            var o = t[e].style, n = r.Direction.value;
                ...
                var e = {
                    mount: function () {
                        ...
                        var e = this, i = 0 < arguments.length && void 0 !== t ? t : 0;
                        this.offset = i, n.emit("move", {movement: this.value}), o.Transition.after(function () {
                ...
                var e = {
                    mount: function () {
                        ...
                        var e = i.settings.classes, t = o.Html.slides[i.index];
                ...
                var t = {
                    mount: function () {
                        ...
                        var t = this.move, e = this.length, i = t.steps, o = t.direction,
                ...
                return d(t, "move", {
                    ...
                    get: function () {
                        var t = r.settings, e = i.Html.slides.length;
                ...
                var i = new x, m = 0, f = 0, g = 0, o = !1, v = !0, n = !!T && {passive: !0}, t = {
                    mount: function () {
                        this.bindSwipeStart()
                    }, start: function (t) {
                        if (!o && !d.disabled) {
                        ...
                        if (!d.disabled) {
                            var e = d.settings, i = e.touchAngle, o = e.touchRatio, n = e.classes, r = this.touches(t),
                                s = y(r.pageX) - f, a = y(r.pageY) - g, l = Math.abs(s << 2), u = Math.abs(a << 2),
                                c = Math.sqrt(l + u), h = Math.sqrt(u);
                        ...
                        if (!d.disabled) {
                            var e = d.settings, i = this.touches(t), o = this.threshold(t), n = i.pageX - f,
                                r = 180 * m / Math.PI, s = Math.round(n / p.Sizes.slideWidth);
                ...
                var o = new x, n = t.settings, r = S(n.breakpoints), s = l({}, n), a = {
                    match: function (t) {
    ...
    e.default = function () {
        ...
        function i(t, e, i, o, n) {
            try {
                var r = document.querySelectorAll(t), s = document.querySelector(e), a = document.querySelector(i),
                    l = function () {
    ...
    function r(n, r, s) {
        var a;
        return function t(e) {
            var i = e - (a = a || e), o = Math.min(i / n, 1);
    ...
    e.default = function () {
        o.then(function () {
            try {
                var t = o.map("map", {center: [55.738164984877976, 37.50722765922547], zoom: 16});
                o.marker([55.7373, 37.5049]).addTo(t)
            } catch (t) {
            }
        })
    }
    ...
    zm = function () {
        ...
        return function n(r, s, a) {
            ...
            1: [function (t, e, i) {
                ...
                t("browserify-css").createStyle(o, {href: "dist/css/styles.full.dark.css"}, {insertAt: "bottom"}), e.exports = o
                ...
                (function (process) {
                    ...
                    "function" != typeof Array.prototype.reduce && (Array.prototype.reduce = function (t, e) {
                        ...
                        var n, r = Object(this), s = r.length >>> 0;
                        ...
                        "use strict";
                        var n = Object.prototype.hasOwnProperty, r = !{toString: null}.propertyIsEnumerable("toString"),
                        ...
                        return function (t) {
                            ...
                            if (r) for (i = 0; i < a; i++) n.call(t, s[i]) && o.push(s[i]);
                            return o
                        }
                        ...
                        for (var o = 2 <= arguments.length ? arguments[1] : void 0, n = 0; n < i; n++) if (n in e && t.call(o, e[n], n, e)) return !0;
                        return !1
                        ...
                        var e = Object(this), i = e.length >>> 0;
                        if ("function" != typeof t) throw new TypeError;
                        for (var o = [], n = 2 <= arguments.length ? arguments[1] : void 0, r = 0; r < i; r++) if (r in e) {
                            var s = e[r];
                        ...
                        var o = Array.prototype.slice.call(arguments, 1), n = this;
                        return e.prototype = this.prototype, i.prototype = new e, i
                    }), Array.prototype.indexOf || (Array.prototype.indexOf = function (t, e) {
                        if (null == this) throw new TypeError('"this" is null or not defined');
                        var i = this.length >>> 0;
                        for (e = +e || 0, Math.abs(e) === 1 / 0 && (e = 0), e < 0 && ((e += i) < 0 && (e = 0)); e < i; e++) if (this[e] === t) return e;
                        return -1
                        ...
                        Rn[t] = {deps: e, callback: i}
                    })("promise/all", ["./utils", "exports"], function (t, e) {
                        "use strict";
                        var i = t.isArray, u = t.isFunction;
                        e.all = function (l) {
                        ...
                        var i, o, n, r, s = "undefined" != typeof window ? window : {},
                            a = s.MutationObserver || s.WebKitMutationObserver, l = window, u = [];
                        i = void 0 !== process && "[object process]" === {}.toString.call(process) ? function () {
                            process.nextTick(e)
                        } : a ? (o = 0, n = new a(e), r = document.createTextNode(""), n.observe(r, {characterData: !0}), function () {
                            r.data = o = ++o % 2
                        }) : function () {
                            l.setTimeout(e, 1)
                        }, t.asap = function (t, e) {
                        ...
                        "use strict";
                        var o = t.Promise, n = e.isFunction;
                        i.polyfill = function () {
                            var t, e;
                        ...
                        function l(t) {
                            ...
                            this._subscribers = [], function (t, e) {
                                function i(t) {
                                    _(e, t)
                                }
                        ...
                        var g = t.config, v = (t.configure, e.objectOrFunction), y = e.isFunction, b = (e.now, i.all),
                            C = o.race, w = n.resolve, x = r.reject, k = s.asap;
                        g.async = k;
                        var D = void 0, L = 0, z = 1, P = 2;
                        l.prototype = {
                            constructor: l,
                            _state: void 0,
                            _detail: void 0,
                            _subscribers: void 0,
                            then: function (t, e) {
                                var i = this, o = new this.constructor(function () {
                                });
                                if (this._state) {
                                    var n = arguments;
                                    g.async(function () {
                                    ...
                                    var n = t._subscribers, r = n.length;
                    ...
                    var oldDG = window.DG, DG = (rr.prototype = L, qr.prototype = new rr, new qr), sr;
                    ...
                    window.__dgApi__ = window.__dgApi__ || {}, DG.version = window.__dgApi__.version, DG.Icon.Default.imagePath = "../img/vendors/leaflet", DG.Map.addInitHook((sr = !1, function () {
                        ...
                        addHandler: function (t, e) {
                            if (!e) return this;
                            var i = this.options[t], o = i === Object(i) ? i : null, n = this[t] = new e(this, o);
                    ...
                    var handlers = window.__dgApi__.callbacks || [], chain = Promise.resolve(), MC, NC, OC, PC, QC, RC;
                    ...
                    handlers.forEach(function (t) {
                        ...
                        var n, r = new RegExp(/.js$/i), s = new RegExp(/.css$/i);
                        ...
                        function handleJsonp(t, e, i, o) {
                            var n = uniqid++, r = t.jsonpCallback || "callback",
                                s = t.jsonpCallbackName || callbackPrefix,
                                a = new RegExp("((^|\\?|&)" + r + ")=([^&]+)"), l = o.match(a),
                                u = doc.createElement("script"), c = 0,
                        ...
                        function getRequest(t, e) {
                            var i, o = this.options, n = (o.type || "GET").toUpperCase(),
                                r = "string" == typeof o ? o : o.url,
                                s = !1 !== o.processData && o.data && "string" != typeof o.data ? Ajax.toQueryString(o.data) : o.data || null,
                                a = !1;
                            return "jsonp" !== o.type && "GET" !== n || !s || (r = urlappend(r, s), s = null), "jsonp" === o.type ? handleJsonp(o, t, e, r) : ((i = xhr(o)).open(n, r, !1 !== o.async), setHeaders(i, o), setCredentials(i, o), win[xDomainRequest] && i instanceof win[xDomainRequest] ? (i.onload = t, i.onprogress = function () {
                            }, i.ontimeout = function () {
                            }, i.onerror = e, a = !0) : i.onreadystatechange = handleReadyState(this, t, e), a ? setTimeout(function () {
                                i.send(s)
                            }, 200) : i.send(s), i)
                        }
                        ...
                        function buildParams(t, e, i, o) {
                            var n, r, s, a = /\[\]$/;
                            if (DG.Util.isArray(e)) for (r = 0; e && r < e.length; r++) s = e[r], i || a.test(t) ? o(t, s) : buildParams(t + "[" + ("object" == typeof s ? r : "") + "]", s, i, o); else if (e && "[object Object]" === e.toString()) for (n in e) e.hasOwnProperty(n) && buildParams(t + "[" + n + "]", e[n], i, o); else o(t, e)
                        }
                        ...
                        function Ajax(t, e) {
                            ...
                            var i = doRequest(e), o = i.promise;
                            return (e.success || e.error || e.complete) && o.then(e.success, e.error), o.abort = i.abort, o
                        }

                        var win = window, doc = document, rurl = /^([\w.+-]+:)?(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,
                            twoHundo = /^20\d$/, ajaxLocParts, ajaxLocation, byTag = "getElementsByTagName",
                            readyState = "readyState", contentType = "Content-Type", requestedWith = "X-Requested-With",
                            head = doc[byTag]("head")[0], uniqid = 0,
                            callbackPrefix = "l_dg_ajax_callback_" + +new Date, lastValue,
                            xmlHttpRequest = "XMLHttpRequest", xDomainRequest = "XDomainRequest", noop = function () {
                            }, defaultHeaders = {
                        ...
                        ajaxLocParts = rurl.exec(ajaxLocation.toLowerCase()) || [], Ajax.setup = function (t) {
                            ...
                            var o, n, r = e || !1, s = [], a = encodeURIComponent;
                            if (DG.Util.isArray(t)) for (n = 0; t && n < t.length; n++) i(t[n].name, t[n].value); else for (o in t) t.hasOwnProperty(o) && buildParams(o, t[o], r, i);
                        ...
                        function e() {
                            ...
                            for (var t, e = 0, i = [], o = [i], n = i; t = r(/^(\()/) || r(/^(\))/) || r(/^(\,)/) || r(/^[-+]?([0-9]*\.[0-9]+|[0-9]+)/);) {
                                if ("(" === t) o.push(n), n = [], o[o.length - 1].push(n), e++; else if (")" === t) {
                        ...
                        function n() {
                            return function () {
                                ...
                                if (s(), !r(/^(\()/)) return null;
                                var t = o();
                                return s(), r(/^(\))/) ? {type: "Point", coordinates: t[0]} : null
                            }() || function () {
                                if (!r(/^(linestring)/i)) return null;
                                if (s(), !r(/^(\()/)) return null;
                                var t = o();
                                return r(/^(\))/) ? {type: "LineString", coordinates: t} : null
                            }() || (r(/^(polygon)/i) ? (s(), {
                                type: "Polygon",
                                coordinates: e()
                            }) : null) || function () {
                                ...
                                s();
                                var t = e();
                                return s(), {type: "MultiPoint", coordinates: t}
                            }() || function () {
                                if (!r(/^(multilinestring)/i)) return null;
                                s();
                                var t = e();
                                return s(), {type: "MultiLineString", coordinates: t}
                            }() || (r(/^(multipolygon)/i) ? (s(), {
                                type: "MultiPolygon",
                                coordinates: e()
                            }) : null) || function () {
                                ...
                                return r(/^(\))/) ? {type: "GeometryCollection", geometries: e} : null
                            }()
                        }
                        ...
                        var t = i.split(";");
                        i = t.pop();
                        var a, l = 0, u = (t.shift() || "").split("=").pop();
                        return (a = n()) && u.match(/\d+/) && (a.crs = {
                            type: "name",
                            properties: {name: "urn:ogc:def:crs:EPSG::" + u}
                        }), a
                        ...
                        initialize: function (t) {
                            ...
                            DG.fallbackProjectsList = DG.fallbackProjectsList || [], DG.projectsList || (DG.projectsList = DG.fallbackProjectsList), delete DG.fallbackProjectsList, this._projectList = DG.projectsList.filter(this._checkProjectData).map(function (t) {
                                var e = DG.Wkt.toGeoJSON(t.bounds), i = DG.geoJSON(e).getBounds(),
                            ...
                            if (this._project !== a) {
                                ...
                                null !== this._project && (this._project = null, setTimeout(function () {
                                    ...
                                    l._map.fire("projectchange", {getProject: l.getProject.bind(l)})
                                }, 1))
                            }
                    ...
                    }), DG.Map.mergeOptions({projectDetector: !0}), DG.Map.addInitHook("addHandler", "projectDetector", DG.ProjectDetector), DG.Metric = function () {
                        ...
                        push: function (t) {
                            ...
                            var t = new DG.Metric.Segments, e = this.length - 1;
                            if (e < 0) return t;
                            ...
                            var e = this.getIndex(t), i = 0 < e ? this[e - 1] : 0;
                            return (t - i) / (this[e] - i)
                        ...
                        initialize: function (t) {
                            ...
                            return this.rotate({cos: e, sin: -i})
                            ...
                            return this.translate({x: -e, y: -i})
                        }, transform: function (t) {
                            var e, i, o, n, r, s, a, l, u = this.vertices, c = u.length;
                            ...
                            scale: function (t, e) {
                                ...
                                var i = e ? e.cos : 1, o = e ? e.sin : 0;
                                return DG.VertexTransform.rotate(t, {cos: i, sin: -o})
                                ...
                                var i = e ? e.x : 0, o = e ? e.y : 0;
                                return DG.VertexTransform.translate(t, {x: -i, y: -o})
                            }, clone: function () {
                                ...
                                return {cos: t.cos * e.cos - t.sin * e.sin, sin: t.sin * e.cos + t.cos * e.sin}
                        ...
                        initialize: function (t) {
                            this._lengths = new DG.Metric.Segments, this._vertices = [[], []], this._drawings = [[], []], this._setPath(t), this.subPath(1)
                        }, load: function () {
                            return this.subPath(1)
                        }, save: function () {
                            return this
                        }, _setPath: function (t) {
                            var e, i, o, n, r, s, a, l = DG.ArrowPathTransform.transform, u = this._vertices,
                                c = this._drawings, h = DG.Point, d = t.width, p = [[], [], []], _ = [];
                            ...
                            o = t.vertices[e + 1].x, n = 4 * d / 3, u[0].push(new h(o, +d)), u[1].push(new h(o, -d)), u[0].push(new h(o - n, +d)), u[1].push(new h(o - n, -d)), c[0].push("L"), c[1].push("L"), _.push(Math.abs(o) - r), u[1].reverse(), c[1].reverse(), a = DG.VertexTransform.getAnglesSum(s.fullAngle, t.getAngle()), l(u, a, u.pop()[0]), o = u[0].length, n = u[1].length, this._arcs = p[2].map(function (t) {
                                ...
                                drawings: ["M", "C"]
                            }, this[1] = {vertices: u[0].concat(u[1]), drawings: ["M"].concat(c[0], "C", c[1])}
                        }, _setAngleAndDisplacement: function (t, e) {
                            this.angle = DG.VertexTransform.getAngle({x: t.x - e.x, y: t.y - e.y}, {
                                x: 0,
                                y: 1
                            }), this.displ = e.clone()
                        }, subPath: function (t) {
                            ...
                            getAngles: function (t) {
                                ...
                                return a.fullAngle = {cos: r.cos, sin: -r.sin}, a
                            }, getTranslatedPath: function (t, e) {
                                var i = new DG.VertexTransform([]), o = e.length - 1, n = t.project(e[o]), r = n.x,
                                    s = n.y;
                                ...
                                for (var o, n, r, s, a = t.length, l = e.cos, u = e.sin, c = i.x, h = i.y; a--;) for (s = (o = t[a]).length; s--;) n = o[s].x - c, r = o[s].y - h, o[s].x = n * l - r * u, o[s].y = n * u + r * l
                            }
                        }
                        ...
                        initialize: function (t, e) {
                            ...
                            var i = e.vertices[0], o = Math.abs(i.y), n = t.vertices[1].x, r = i.x, s = n - r + o + o;
                        ...
                        options: {fill: !0, fillOpacity: 1, interactive: !1},
                        initialize: function (t) {
                        ...
                        _project: function () {
                            ...
                            this._map && (t = this._map.getZoom(), i.visibility.isShown && i.transform[t] ? (e = 2.2 - .2 * (19 - t), i.weight !== e && this.setStyle({weight: +e.toFixed(2)}), this._vertices[0] = i.transform[t].vertices, this._drawings[0] = i.transform[t].drawings, this._pxBounds = i.transform[t]._pxBounds) : (this._vertices[0] = this._empty, this._drawings[0] = this._empty, this._pxBounds = this._pxEmpty))
                        },
                        _update: function () {
                        ...
                        _updateComplexPath: function (t, e) {
                            var i, o, n, r, s, a, l, u, c, h, d = t._drawings, p = t._vertices, _ = this._ctx;
                        ...
                        complexPointsToPath: function (t, e, i) {
                            var o, n, r, s, a, l, u = "", c = DG.Browser.svg;
                            for (o = 0; o < t.length; o++) {
                                if (l = t[o], c) for (n = r = 0; n < l.length;) {
                                    switch (a = e[o][r++]) {
                                        case"C":
                                        case"c":
                                            s = 3;
                        ...
                        initialize: function (t, e) {
                            ...
                            var e, i, o, n = this.dpoints[0], r = 1 - t;
                            ...
                            var e, i, o, n, r, s, a, l, u, c = this.points, h = this.order;
                            ...
                            var e, i, o, n, r, s = this._lut = [], a = this.points;
                            s.push({x: a[0].x, y: a[0].y, l: 0});
                            for (var l = 1; l < t; l++) o = (i = 1 - (e = l / t)) * i, n = i * e * 2, r = e * e, s.push({
                                x: o * a[0].x + n * a[1].x + r * a[2].x,
                                y: o * a[0].y + n * a[1].y + r * a[2].y
                            });
                            s.push({x: a[2].x, y: a[2].y, l: 0})
                        }, _setLUT3: function (t) {
                            var e, i, o, n, r, s, a, l, u = this._lut = [], c = this.points;
                            u.push({x: c[0].x, y: c[0].y, l: 0});
                        ...
                        initialize: function (t, e, i) {
                            ...
                            var e, i = this.getLUT(), o = i.length - 1, n = 0;
                            if (t <= 0) return 0;
                            if (1 <= t) return 1;
                        ...
                        options: {}, initialize: function (t) {
                            ...
                            var i, o, n = this._animation[t].frames, r = {progress: e};
                            if (n) for (var s in n) n[s].progress ? r[s] = n[s].progress(e) : (i = n[s].from, o = n[s].to, r[s] = i + (o - i) * e);
                            return r
                        }
                        ...
                        options: {
                            ...
                            this.options.vectors.map(function (t) {
                                ...
                                var e = DG.Util.create(o), i = DG.latLngBounds(t);
                            ...
                            var t, e = this._map, i = this.getBounds();
                            ...
                            }, this), e.setView(i.getCenter(), t, {animate: !0})), this
                        ...
                        animation: [{
                            function: DG.Animation.EASE_IN_OUT,
                            duration: 250,
                            frames: {distance: {from: 0, to: .6}}
                        }, {
                            function: DG.Animation.EASE_IN,
                            duration: 135,
                            frames: {distance: {from: .6, to: 0}}
                        }, {
                            function: DG.Animation.EASE_OUT,
                            duration: 135,
                            frames: {distance: {from: 0, to: .16}}
                        }, {
                            function: DG.Animation.EASE_IN,
                            duration: 90,
                            frames: {distance: {from: .16, to: 0}}
                        }, {
                            function: DG.Animation.EASE_OUT,
                            duration: 90,
                            frames: {distance: {from: 0, to: .06}}
                        }, {function: DG.Animation.EASE_IN, duration: 50, frames: {distance: {from: .06, to: 0}}}]
                    }, DG.Entrance.Arrow = DG.FeatureGroup.extend({
                        initialize: function (t) {
                            DG.LayerGroup.prototype.initialize.call(this), DG.setOptions(this, t), this._progress = 1, this._distance = 0, this._visibility = {isShown: !1}, this._position = t.latlngs[t.latlngs.length - 1], this._shape = this.options.shape || DG.Entrance.Arrow.SHAPE, this._apt = {}, this._att = {}
                            ...
                            var t, e, i, o, n = this._map || this._mapToAdd, r = n ? n.getZoom() : 0,
                                s = this._shape.vertices[r], a = this._shape.drawings[r], l = this.options.latlngs;
                            ...
                            var n = i.subPath(1).translate(t).vertices, r = o.subShape(i).translate(t).vertices;
                        ...
                        vertices: {
                            16: [[-6.5, -1.8], [-6.0522, -1.8], [-7.0975, -5.2537], [-6.6619, -6.2565], [-6.598, -6.355], [-6.1757, -6.147], [.8371, -.3552], [.9275, -.1764], [.9275, .1764], [.8371, .3552], [-6.1757, 6.147], [-6.598, 6.355], [-6.6619, 6.2565], [-7.0975, 5.2537], [-6.0522, 1.8], [-6.5, 1.8]],
                            17: [[-9, -2.4], [-7.889, -2.4], [-9.9245, -7.2548], [-9.3363, -8.6404], [-9.3448, -8.6448], [-8.8717, -8.3508], [1.0285, -.3552], [1.119, -.1764], [1.119, .1764], [1.0285, .3552], [-8.8717, 8.3508], [-9.3448, 8.6448], [-9.3363, 8.6404], [-9.9245, 7.2548], [-7.889, 2.4], [-9, 2.4]],
                            18: [[-11.5, -3], [-10.0795, -3], [-12.4909, -9.3173], [-11.8402, -10.7654], [-11.5986, -10.7073], [-10.938, -10.2258], [1.1497, -.3552], [1.2402, -.1764], [1.2402, .1764], [1.1497, .3552], [-10.938, 10.2258], [-11.5986, 10.7073], [-11.8402, 10.7654], [-12.4909, 9.3173], [-10.0795, 3], [-11.5, 3]],
                            19: [[-13, -3.6], [-11.66, -3.6], [-14.1696, -10.8351], [-13.5189, -12.2832], [-13.2773, -12.2251], [-12.6167, -11.7436], [1.3061, -.3552], [1.3966, -.1764], [1.3966, .1764], [1.3061, .3552], [-12.6167, 11.7436], [-13.2773, 12.2251], [-13.5189, 12.2832], [-14.1696, 10.8351], [-11.66, 3.6], [-13, 3.6]]
                        },
                        drawings: {
                        ...
                        }, _originalUpdateZIndex: DG.Marker.prototype._updateZIndex, _updateZIndex: function (t) {
                        ...
                        onRemove: function (t) {
                            this._animateClosing(), t.off({
                                entranceshow: this._closePopup,
                                resize: this.resize
                            }, this), DG.DomUtil.TRANSITION ? this._removeTimeout = setTimeout(L.bind(L.DomUtil.remove, L.DomUtil, this._container), 200) : L.DomUtil.remove(this._container), t.fire("popupclose", {popup: this}), this._source && this._source.fire("popupclose", {popup: this}, !0)
                        },
                        ...
                        _initLayout: function () {
                            PC.call(this), DG.DomEvent.on(this._contentNode, "wheel", function (t) {
                                var e;
                                if (t.composedPath) e = t.composedPath(); else {
                                    var i = t.target;
                        ...
                        resize: function () {
                            ...
                            if (this._updatePosition(), t) if (this._isBaronExist) {
                        ...
                        _adjustPan: function (t) {
                            if (this._map) {
                                ...
                                var e = this.options;
                                if (e.autoPan) {
                                    var i = this._map, o = this._container.offsetHeight, n = this._containerWidth,
                                    ...
                                    var a = i.layerPointToContainerPoint(r), l = L.point(s),
                                        u = L.point(e.autoPanPaddingTopLeft || l),
                                        c = L.point(e.autoPanPaddingBottomRight || l), h = i.getSize(), d = 0, p = 0;
                        ...
                        _onScroll: function (t) {
                            this.fire("scroll", {originalEvent: t})
                        },
                        _onClick: function (t) {
                            t.target = t.target || t.srcElement, this._moving || this.fire("click", {originalEvent: t})
                        },
                        _onStart: function (t) {
                        ...
                        _onMove: function (t) {
                            if (t.touches && 1 < t.touches.length) this._moved = !0; else {
                                var e = t.touches && 1 === t.touches.length ? t.touches[0] : t,
                                    i = DG.point(e.clientX, e.clientY), o = Math.abs(i.subtract(this._startPoint).y);
                        ...
                        _getDelta: function () {
                            var t = 0, e = this._popupStructure;
                            return e.header && (t += e.header.offsetHeight), e.footer && (t += e.footer.offsetHeight), t
                        },
                        _updateLayout: function () {
                            var t, e = this.options, i = this._contentNode, o = this._wrapper, n = i.style, r = o.style,
                                s = "leaflet-popup-scrolled", a = !1;
                        ...
                        t: function (t, e) {
                            ...
                            return void 0 === this.constructor.Dictionary[r] && (r = "ar" === r ? "en" : DG.config.defaultLang), (n = void 0 !== (o = this.constructor.Dictionary[r][t])) ? (i = n ? o : t, void 0 !== e && (e = parseInt(e, 10), e = isNaN(e) ? 0 : e, i = o[this.constructor.Dictionary[r].pluralRules(e)]), i = DG.Util.template(i, {n: e})) : t
                        }
                    }, DG.Map.include({
                        setLang: function (t) {
                            t && "[object String]" === Object.prototype.toString.call(t) && (this.options.currentLang = t, this.fire("langchange", {lang: t}))
                        }, getLang: function () {
                    ...
                    var ie9 = ($E = document.createElement("div"), _E = $E.getElementsByTagName("i"), $E.innerHTML = "\x3c!--[if IE 9]><i></i><![endif]--\x3e", Boolean(_E[0])),
                        ...
                        wasPreviouslyDisabled = !1, $E, _E;
                    try {
                        wasPreviouslyDisabled = "false" === localStorage.getItem("DGMuseum")
                    } catch (t) {
                    }
                    DG.Map.mergeOptions({museum: !wasPreviouslyDisabled && (DG.Browser.ielt9 || ie9 || DG.Browser.opera12 || safari51)}), DG.Map.Museum = DG.Handler.extend({
                        statics: {
                            Dictionary: {
                                ar: {wearesorry: "لا نضمن لك تشغيل ثابت للتطبيق على متصفحك. حاول التحديث:"},
                                cs: {wearesorry: "Nezaručujeme stabilní fungování aplikace ve Vašem prohlížeči. Zkuste provést aktualizaci:"},
                                en: {wearesorry: "We do not guarantee stable operation of the application in your browser. Try updating:"},
                                es: {wearesorry: "No garantizamos un funcionamiento estable de la aplicación en su buscador. Intente actualizarlo:"},
                                it: {wearesorry: "Non garantiamo il funzionamento stabile dell'applicazione nel tuo browser. Prova ad aggiornare:"},
                                ru: {wearesorry: "Мы не гарантируем стабильную работу приложения в вашем браузере. Попробуйте обновиться:"}
                            }
                        }, includes: [DG.Locale], initialize: function (t) {
                        ...
                        iconAnchor: [10, 32]
                    }, DG.Map.mergeOptions({bounceAtZoomLimits: !1});
                    ...
                    }, DG.Layer.mergeOptions({nonBubblingEvents: ["click", "dblclick", "mouseover", "mouseout", "contextmenu"]}), L.Canvas.include({
                    ...
                    var initMap = DG.Map.prototype.initialize, panBy = DG.Map.prototype.panBy,
                        getBoundsZoom = DG.Map.prototype.getBoundsZoom, setMaxZoom = DG.Map.prototype.setMaxZoom;
                    DG.Map.include({
                        _tileLayersNumber: 0, _mapMaxZoomCache: null, initialize: function (t, e) {
                            e = DG.extend({wheelPxPerZoomLevel: 1e4}, e), this.metaLayers = [], initMap.call(this, t, e), this.options.center && void 0 !== this.options.zoom && this.setView(DG.latLng(this.options.center), this.options.zoom, {reset: !0}), this._lastMetalayer = {
                                layer: void 0,
                                entity: void 0
                            }
                            ...
                            var i = panBy.call(this, t, e), o = this._restrictZoom(this.getCenter());
                            ...
                            if (this.projectDetector.enabled()) {
                                var e = this.projectDetector.getProject(), i = this.projectDetector.isProjectHere(t);
                            ...
                            var i = this.project(t, e), o = this.getSize().divideBy(2),
                                n = this.unproject(i.subtract(o), e), r = this.unproject(i.add(o), e);
                            ...
                            if (this._layers && this.projectDetector.enabled() && 0 === this._tileLayersNumber) {
                                var i = this.options, o = !!i.maxZoom, n = this.baseLayer, r = this._getNewBounds(t, e),
                            ...
                            if (13 !== t.keyCode) {
                                ...
                                if (!t._stopped && (i = (i || []).concat(this._findEventTargets(t, e))).length) {
                                    ...
                                    var r = {originalEvent: t, eventTargets: i, eventTargetsMapIndex: i.indexOf(this)};
                                    if ("keypress" !== t.type) {
                            ...
                            if (e === this._container || DG.Browser.ie && "leaflet-tile leaflet-tile-loaded" === e.className || "CANVAS" === e.tagName) for (var o = this.metaLayers.length - 1; 0 <= o; o--) {
                                var n = this.metaLayers[o].getHoveredObject(t);
                                if (n) return {layer: this.metaLayers[o], entity: n};
                                if (i) return {layer: this.metaLayers[o], entity: void 0}
                            }
                            return {layer: void 0, entity: void 0}
                        ...
                        function t() {
                            var t = this.getLang(), e = this.projectDetector && this.projectDetector.getProject();
                        ...
                        var i = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAQAAAAEAAQMAAABmvDolAAAAA1BMVEX28t5R0k5UAAAAH0lEQVR4Xu3AAQkAAADCMPunNsdhWxwAAAAAAAAAwAEhAAABg2UP5AAAAABJRU5ErkJggg==",
                            ...
                            n = DG.Browser.mobile ? DG.MobileTileLayer : DG.TileLayer, e = n.extend({
                                initialize: function (t, e) {
                    ...
                    }), DG.Map.mergeOptions({tilesCheck: !0}), DG.Map.TilesCheck = DG.Handler.extend({
                        initialize: function (t) {
                            ...
                            if (0 === this._map.getTileLayersNumber() && this._map._loaded) {
                                var t = this._layer._tileZoom, e = this._layer.options.errorTileUrl,
                                    i = this._layer.getTiles();
                                for (var o in i) if (i[o].coords.z === t && i[o].el.src !== e) return;
                                this._map.zoomOut()
                            }
                    ...
                    DG.Map.Drag.include({
                        ...
                        for (var o = !1, n = 0, r = e.length - 1; n < e.length; r = n++) {
                            var s = i(e[n]), a = i(e[r]), l = s[0], u = s[1], c = a[0], h = a[1];
                        ...
                        L.DomUtil.removeClass = function (t, e) {
                            ...
                            _onDragEnd: function (t) {
                                var e = this._map, i = e.options, o = !i.inertia || this._times.length < 2;
                                if (e.fire("dragend", t), o) e.fire("moveend"); else {
                                    var n = this._lastPos.subtract(this._positions[0]),
                                        r = (this._lastTime - this._times[0]) / 1e3, s = i.easeLinearity,
                                        a = n.multiplyBy(s / r), l = a.distanceTo([0, 0]),
                                        u = Math.min(i.inertiaMaxSpeed, l), c = a.multiplyBy(u / l),
                                        h = c.multiplyBy(-.5).round();
                                    h.x || h.y ? (h = e._limitOffset(h, e.options.maxBounds), L.Util.requestAnimFrame(function () {
                                        e.panBy(h, {duration: 1, easeLinearity: s, noMoveStart: !0, animate: !0})
                                    })) : e.fire("moveend")
                                }
                            }
                        })
                        ...
                        initialize: function (t, e) {
                            ...
                            if (void 0 !== t) {
                                ...
                                var o = this._levels[t], n = this._map;
                            ...
                            if (e) {
                                ...
                                if (void 0 === t && (t = e.getCenter()), void 0 !== this._tileZoom) {
                                    var o = this._getTiledPixelBounds(t), n = this._pxBoundsToTileRange(o),
                                        r = n.getCenter(), s = [], a = this.options.keepBuffer,
                                    ...
                                    for (var h = n.min.y; h <= n.max.y; h++) for (var d = n.min.x; d <= n.max.x; d++) {
                                    ...
                                    }), 0 !== s.length) for (this._loading || (this._loading = !0, this.fire("loading")), d = 0; d < s.length; d++) this._addTile(s[d], this._level.el)
                                }
                            }
                            ...
                            e.z = t.z - 1;
                            var i = this._tileCoordsToKey(e), o = this._tiles[i];
                            return o && !o.preview
                        }, _existTilesFromHigherZoom: function (t) {
                            for (var e = t.x, i = t.y, o = 2 * e; o < 2 * e + 2; o++) for (var n = 2 * i; n < 2 * i + 2; n++) {
                            ...
                            var i = this._getTilePos(t), o = this._tileCoordsToKey(t), n = this._wrapCoords(t),
                                r = this._needPreviewTile(n), s = r ? this._previewUrl : this._url,
                        ...
                        onAdd: function (t) {
                            ...
                            return this._map = t, this._zoomInButton = this._createButton(DG.Util.template(i, {type: "in"}), this.t("zoom_in"), "dg-control-round " + e + "__in", o, this._zoomIn, this), this._zoomOutButton = this._createButton(DG.Util.template(i, {type: "out"}), this.t("zoom_out"), "dg-control-round " + e + "__out", o, this._zoomOut, this), this._updateDisabled(), t.on("zoomend zoomlevelschange", this._updateDisabled, this), o
                        }, _originalCreateButton: DG.Control.Zoom.prototype._createButton, _createButton: function () {
                            var t = Array.prototype.slice.call(arguments),
                                e = this._originalCreateButton.apply(this, t), i = e.children[0],
                                o = "dg-control-round_state_active", n = "dg-control-round__icon_state_active";
                        ...
                        zoom_in: "Acercar",
                        zoom_out: "Alejar"
                    }, DG.Control.Zoom.Dictionary.ar = {zoom_in: "", zoom_out: ""};
                    ...
                    _dereq_("dustjs-helpers"), DG.dust = function (t, e) {
                        ...
                        options: {position: "bottomright"}, _getLink: function (t) {
                            var e = {
                                ru: {
                        ...
                        _visualizeLocation: function () {
                            ...
                            if (this._locateOnNextLocationFound) {
                                if (this._isOutsideMapBounds()) this.options.onLocationOutsideMapBounds(this); else if (this._locateOptions.setView) {
                            ...
                            var o = {icon: DG.divIcon({className: i, iconSize: [20, 20]})};
                        ...
                        statics: {Dictionary: {}},
                        options: {position: "topright", iconClass: "fullscreen"},
                        initialize: function (t) {
                    ...
                    }, DG.Map.mergeOptions({fullscreenControl: !0}), DG.Map.addInitHook(function () {
                        ...
                        options: {tileSize: 256, minZoom: 0, maxZoom: 19, zoomOffset: 0, eventBubbling: "transparent"},
                        initialize: function (t, e) {
                            DG.TileLayer.prototype.initialize.call(this, null, e), delete this._url, this._currentTileKey = "", this._currentTileData = [], this._lastEntity = void 0, this._dispatchMouseEvents = !0, this._origin = DG.Meta.origin(t, {dataFilter: this.options.dataFilter})
                        },
                        getOrigin: function () {
                            return this._origin
                        },
                        onAdd: function (t) {
                            ...
                            DG.Browser.touchEnabled && this.options.isPoi && t.eachLayer(function (t) {
                                if (t instanceof L.TileLayer) for (var e in t.on("tileloadstart", i._onTileLoadStart, i), t._tiles) i._onTileLoadStart({coords: t._tiles[e].coords})
                            })
                        },
                        onRemove: function (t) {
                            var e = this;
                            ...
                            var i = t.metaLayers.indexOf(this);
                            -1 !== i && t.metaLayers.splice(i, 1), t.off("rulerstart", this._disableDispatchMouseEvents, this), t.off("rulerend", this._enableDispatchMouseEvents, this)
                        },
                        getEvents: function () {
                            return {
                        ...
                        getHoveredObject: function (t) {
                            var e, i = this.getTileSize(), o = this._map.mouseEventToLayerPoint(t.originalEvent),
                                n = this._map.getPixelOrigin().add(o), r = n.unscaleBy(i).floor(),
                                s = DG.point(n.x % i.x, n.y % i.y), a = this._map.getZoom(), l = this;
                        ...
                        mapEvents: {
                            mousemove: function (t) {
                                ...
                                var t = this.getTileSize(), e = this._map.mouseEventToLayerPoint(i.originalEvent),
                                    o = this._map.getPixelOrigin().add(e), n = o.unscaleBy(t).floor(),
                                ...
                                var a = this._origin.getTileKey(n), l = this;
                                this._origin.getTileData(n, function (t) {
                                    t ? s(t) : l._origin._requests[a] && (DG.DomEvent.stop(i), l._origin._requests[a].then(function () {
                                        if (delete i.originalEvent._stopped, s(l._origin._tileStorage[a]), !i.originalEvent._stopped) for (var t = i.eventTargets, e = i.eventTargetsMapIndex; e < t.length; e++) if (t[e].fire("click", i, !0), i.originalEvent._stopped || t[e].options.nonBubblingEvents && -1 !== L.Util.indexOf(t[e].options.nonBubblingEvents, "click")) return
                                    }))
                                })
                            }, dblclick: function (t) {
                        ...
                        _fireMetalayerEvent: function (t, e) {
                            if (e.entity && this._dispatchMouseEvents) {
                                this.fire(t, {meta: e.entity, latlng: this._map.mouseEventToLatLng(e.originalEvent)});
                        ...
                        _getHoveredObject: function (t) {
                            if (this._currentTileData) for (var e = 0; e < this._currentTileData.length; e++) if (DG.PolyUtil.inside(t, this._currentTileData[e].geometry, this._pointReduceHelper)) return this._currentTileData[e]
                        },
                        _pointReduceHelper: function (t) {
                            return [t.x, t.y]
                        },
                        _setView: function (t, e, i, o) {
                            var n = Math.round(e), r = this._tileZoom !== n;
                            !o && r && (this._tileZoom = n, this._resetGrid())
                        }
                    }), DG.Meta.layer = function (t, e) {
                        return new DG.Meta.Layer(t, e)
                    }, DG.Meta.Origin = DG.Class.extend({
                        options: {subdomains: "0123", dataFilter: null}, _url: !1, initialize: function (t, e) {
                            ...
                            var i = this.getTileKey(e), o = this, n = "function" == typeof t ? t : function () {
                            };
                            ...
                            return DG.ajax(this._prepareURL(t), {type: "get", dataType: "json"})
                        }, _prepareURL: function (t) {
                            return DG.Util.template(this._url, {x: t.x, y: t.y, z: t.z, s: this._getSubdomain(t)})
                        }, _getSubdomain: DG.TileLayer.prototype._getSubdomain
                    }), DG.Meta.origin = function (t, e) {
                        return new DG.Meta.Origin(t, e)
                    }, DG.Map.mergeOptions({poi: !0}), DG.Poi = DG.Handler.extend({
                        options: {disableLabel: !1}, initialize: function (t, e) {
                            ...
                            return "" === t.responseText ? [] : t.result.poi.map(function (t) {
                                ...
                                return t.geometry = {type: "MultiPolygon", coordinates: e}, t
                            })
                    ...
                    }), DG.Map.addInitHook("addHandler", "poi", DG.Poi), DG.Map.mergeOptions({geoclicker: !1}), DG.Geoclicker = DG.Handler.extend({
                        clickCount: 0, pendingClick: 0, timeout: 250, initialize: function (t, e) {
                        ...
                        initialize: function (t) {
                            ...
                            var e = t.zoom, i = t.latlng, o = t.beforeRequest || function () {
                            }, n = this.getTypesByZoom(e), r = i.lng + "," + i.lat;
                            ...
                            var i = {building_id: t, page: (e = e || {}).page || 1};
                            ...
                            var o = {point: t, type: e, zoom_level: i, fields: this._geoFields};
                            return this._performRequest(o, this._urlGeoSearch)
                        }, geoGet: function (t) {
                            var e = {id: t, fields: this._geoFields};
                            ...
                            var i = DG.extend({key: this._key}, t), o = "get";
                        ...
                        handle: function () {
                            return Promise.resolve({tmpl: "popupHeader", data: {title: this.t("we_have_not")}})
                        },
                        ...
                        _runEventHandlers: function (t) {
                            ...
                            for (var i in this._eventHandlers) if (this._eventHandlers.hasOwnProperty(i) && -1 < e.className.indexOf(i)) return DG.DomEvent.preventDefault(t.originalEvent), void this._eventHandlers[i].call(this, e)
                        },
                        ...
                        handle: function (t, e) {
                            return Promise.resolve({tmpl: e + ":<br/>" + t[e].id})
                        }
                    }), DG.Geoclicker.Handler.ApiError = DG.Geoclicker.Handler.Default.extend({
                        handle: function () {
                            var t = this._view.render({tmpl: "popupHeader", data: {title: this.t("apiErrorTitle")}});
                            return Promise.resolve({header: t, tmpl: this.t("apiErrorBody")})
                        }
                    }), DG.Geoclicker.Handler.CityArea = DG.Geoclicker.Handler.Default.extend({
                        _polylineStyleDefault: {fillColor: "#ff9387", color: "#ff9387", noClip: !0, opacity: 1},
                        _polylineStyles: {
                            11: {fillOpacity: .18, weight: 1},
                            12: {fillOpacity: .12, weight: 1},
                            13: {fillOpacity: .08, weight: 2},
                        ...
                        _fillCityAreaObject: function (t, e) {
                            ...
                            return i.drilldown = this._getDrilldown(t[e]), t[e].name && (i.name = t[e].name), {
                                tmpl: "cityarea",
                                data: i,
                                header: this._view.render({tmpl: "popupHeader", data: {title: i.name}})
                            }
                        },
                        ...
                        options: {showBooklet: !0, showPhotos: !0, showRouteSearch: !0},
                        handle: function (t) {
                        ...
                        _initFirmList: function (t) {
                            if (!t) return !1;
                            var e = t.result.items, i = this._firmListSetup();
                        ...
                        _fillFirmListObject: function (t) {
                            ...
                            return {
                                ...
                                footer: this._view.render({
                                    ...
                                    data: {btns: [{name: "back", label: this.t("back_button"), icon: !0}]}
                                }),
                        ...
                        _pasteLoader: function () {
                            ...
                            t.insertBefore(e, t.firstChild), t.style.height = this._popup._contentNode.offsetHeight - 1 + "px", t.style.width = this._popup._contentNode.offsetWidth + "px", this._clearAndRenderPopup({tmpl: t})
                        },
                        ...
                        _handlePaging: function () {
                            if (this._page++, this._totalPages && this._page <= this._totalPages && this._api.firmsInHouse(this._id, {page: this._page}).then(DG.bind(this._appendFirmList, this)), this._page === this._totalPages) {
                        ...
                        _getAddressString: function (t) {
                            ...
                            var e = {}, i = DG.DomUtil.create("div", "dg-building-callout__body"),
                                o = t.links && t.links.branches, n = this._getDrilldown(t);
                            return t.building_name ? e.address = {
                                header: this._getAddressString(t),
                                drilldown: n
                            } : n && (e.address = {drilldown: n}), e.purpose = t.purpose_name + (t.floors ? ", " + this.t("n_floors", t.floors.ground_count) : ""), o && 0 < o.count && (this._totalPages = Math.ceil(t.links.branches.count / this._firmsOnPage)), t.links && t.links.attractions && t.links.attractions.length && (e.attractions = t.links.attractions.reduce(function (t, e) {
                                return e.name && t.push(e.name), t
                            ...
                            var e = [], i = t.links && t.links.branches;
                            ...
                            }), this._view.render({tmpl: "popupFooterBtns", data: {btns: e}})
                        }, _getShowAllData: function (t) {
                            return {name: "all", label: this.t("show_organization_in_building", t)}
                        ...
                        handle: function (t) {
                            ...
                            var e = t.attraction, i = {}, o = this,
                                n = {btns: [{name: "goto", label: this.t("go_to"), icon: !0}]};
                            return e.name ? (i.buildingName = e.name, i.purpose = e.subtype_name) : i.buildingName = e.subtype_name, i.description = e.description, i.drillDown = this._getDrilldown(e), this._checkDescFieldHeight(i.description) && (i.showMoreText = this.t("show_more_about_sight")), n.btns[0].href = this._getDirectionsUrl(i.buildingName), {
                                tmpl: "sight",
                                data: i,
                                header: this._view.render({tmpl: "popupHeader", data: {title: i.buildingName}}),
                                footer: this._view.render({tmpl: "popupFooterBtns", data: n}),
                                afterRender: function () {
                        ...
                        initialize: function (t, e) {
                            ...
                            var t = !1, e = "Webkit Moz O ms Khtml".split(" "), i = document.createElement("div");
                            if (i.style.animationName && (t = !0), !1 === t) for (var o = 0; o < e.length; o++) if (void 0 !== i.style[e[o] + "AnimationName"]) {
                                t = !0;
                                break
                            }
                            return t
                        ...
                        options: {
                            ...
                            if (ga(DG.config.gaName + ".send", "event", "Geoclicker", "Use"), i && i.linked && "sight" != i.linked.type && "attraction" != i.linked.type) {
                                ...
                                o(), n.handleResponse({poi: {reference: i.linked}})
                            ...
                            for (var e in this.options.handlersSequence) if (t[e]) return e;
                            return null
                    ...
                    FirmCard.prototype = {
                        render: function (t) {
                            ...
                            e = this._schedule.transform(a.schedule, {
                                ...
                                firmName: a.name,
                                links: o
                            }), l.innerHTML = t, this._firmContentObject.tmpl = l, n.length && (this._footerContainer = document.createElement("div"), this._footerContainer.innerHTML = this.options.render("popupFooterBtns", {btns: n}), this._firmContentObject.footer = this._footerContainer), this.options.onFirmReady && this.options.onFirmReady(this._firmContentObject)
                        }, _renderError: function () {
                            this._firmContentObject.header = this.options.render("popupHeader", {title: this.options.t("apiErrorTitle")}), this._firmContentObject.tmpl = this.options.t("apiErrorBody"), this.options.onFirmReady && this.options.onFirmReady(this._firmContentObject)
                        }, _getConfigFirmCardBody: function (t, e, i, o, n) {
                            return [{
                                tmpl: "firmCardAddr",
                                data: {address: t.address_name, comment: t.address_comment}
                            }, {tmpl: "firmCardContacts", data: {groups: t.contact_groups}}, {
                                tmpl: "firmCardSchedule",
                                data: {schedule: e, forecast: i}
                            }, {tmpl: "frimCardPayments", data: {payments: o}}, {
                                tmpl: "firmCardRubric",
                                data: {rubrics: n}
                            }]
                            ...
                            var e, t, i = [], o = this._firmData.reviews;
                            ...
                            for (var n, r = this._firmData.external_content, s = 0; s < r.length; s++) if ("photo_album" == r[s].type && "common" == r[s].subtype) {
                                n = r[s];
                                break
                            }
                            ...
                            "dg-popup__button_name_firm-card-back": function () {
                                ...
                                var t = new this.options.showEntrance({vectors: this._firmData.links.entrances[0].geometry.vectors});
                            ...
                            var e = t.originalEvent.target;
                            for (var i in this._events) if (this._events.hasOwnProperty(i) && -1 < e.className.indexOf(i)) return DG.DomEvent.preventDefault(t.originalEvent), void this._events[i].call(this, e)
                        }, _onClose: function (t) {
                        ...
                        renderList: function (t) {
                            ...
                            if (t) {
                                var i = "_" + e + "Firm";
                                if (this._isArray(t)) for (var o = 0, n = t.length; o < n; o++) this[i](t[o]); else this[i](t)
                            }
                        }, addFirms: function (t) {
                            ...
                            }).id in this._firms || (e = this._createListItem(), o = n ? this.options.firmCard.render(n, {firm: i}) : i.name, e.insertAdjacentHTML("beforeend", o), this._firms[i.id] = e, this._container.appendChild(e))
                        ...
                        setLang: function (t) {
                            ...
                            function k(t, o) {
                                return D(t.map(function (t, e, i) {
                                    return {value: t, index: e, criteria: o.call(this, t, e, i)}
                                }).sort(function (t, e) {
                                    var i = t.criteria, o = e.criteria;
                                    if (i !== o) {
                            ...
                            function L(t) {
                                ...
                                for (var s = 0; s < t.working_hours.length; s++) e = t.working_hours[s].from, o = y(i = t.working_hours[s].to) - y(e), n = b(i) - b(e), (o < 0 || 0 == o && n <= 0) && (i = +y(i) + 24 + ":" + b(i)), r[2 * s] = {
                                    time: e,
                                    type: "open"
                                }, r[2 * s + 1] = {time: i, type: t.working_hours.length - 1 === s ? "close" : "lunch"};
                                return r
                            }
                            ...
                            function n(n, r) {
                                ...
                                var a = [0, 0, 0, 0, 0, 0, 0], l = 0;
                                return M.forEach(function (t, e) {
                                    if (u(r[t], n) || !r[t] && null === n) s.dayList.push(c[e]), a[w(e + d)] = 1, l++; else {
                                        if (2 < l) {
                            ...
                            if (v) {
                                ...
                                P = i[w(new Date(A).getDay() - d)], function (t) {
                                    var e, i, o, n, r, s, a = [];
                                    G.now = {}, (i = function (t) {
                                    ...
                                    for (var l = 0; l < i.length; l++) if (A >= (i[l - 1] && i[l - 1].ts || 0) && A < i[l].ts) {
                                        var u = Math.floor((i[l].ts - A) / 36e5),
                                            c = Math.floor((i[l].ts - A) / 6e4 - 60 * u), h = new Date(A),
                                            d = "open" !== i[l].type,
                                        ...
                                        var m = new Date(i[l].ts), f = m.getHours(), g = m.getMinutes();
                                    ...
                                    if (t) {
                                        ...
                                        E = C(e[0]), T = C(e[e.length - 1]), G.today = E === T ? {
                                            ...
                                            from: "00:00",
                                            to: "24:00"
                                        } : {from: E, to: T}, 0 < a.length && (G.lunch = a, G.lunchStr = S(O, "lunch"))
                                    }
                                }(v[P]);
                                var a = [], p = 0, _ = 0, m = [];
                                ...
                                }(); else if (1 === _) G.week = {evently: [n(v[M[0]], v)]}; else {
                                    for (s = 0; s < _; s++) if (m[s] = 0, a[s]) for (var f = D(L(a[s]), "time"), g = 0; g < f.length; g += 2) {
                        ...
                        options: {period: 0, disableLabel: !1, updateWhenIdle: !1},
                        statics: {Dictionary: {}},
                        initialize: function (t) {
                        ...
                        onAdd: function (t) {
                            if (this._initContainer(), this._levels = {}, this._tiles = {}, this.options.period) this.options.timestampString = "", this._onAddSetParams(t); else {
                                var e = this;
                        ...
                        update: function () {
                            ...
                            this._getTimestampString().then(function (t) {
                                ...
                                e.fire("update", {timestamp: e.options.timestampString}), e._layerEventsListeners.mouseout.call(e), e._metaLayer.getOrigin().setURL(e._prepareMetaURL(), e), e.redraw()
                            })
                        },
                        ...
                        _processData: function (t, e) {
                            var i = e.scaleBy(this.getTileSize()), o = DG.bind(this._polygonLngLatToPoints, this, i),
                                n = {};
                    ...
                    }, DG.Traffic.Dictionary.ru = {speed_unit_km_h: "км/ч"}, DG.Traffic.Dictionary.it = {speed_unit_km_h: "km/h"}, DG.Traffic.Dictionary.cs = {speed_unit_km_h: "km/h"}, DG.Traffic.Dictionary.es = {speed_unit_km_h: "km/h"}, DG.Traffic.Dictionary.en = {speed_unit_km_h: "km/h"}, DG.Traffic.Dictionary.ar = {speed_unit_km_h: "كم/ساعة"}, DG.Control.Traffic = DG.RoundControl.extend({
                        options: {position: "topright", iconClass: "traffic"},
                        statics: {Dictionary: {}},
                        initialize: function (t) {
                        ...
                        _updateControlVisibility: function () {
                            var t = this._map.projectDetector.getProject(), e = t && t.traffic,
                    ...
                    }, DG.Map.mergeOptions({trafficControl: !1}), DG.Map.addInitHook(function () {
                    ...
                    }), DG.Control.Traffic.Dictionary.ru = {button_title: "Пробки"}, DG.Control.Traffic.Dictionary.it = {button_title: "Colonna"}, DG.Control.Traffic.Dictionary.cs = {button_title: "Zácpy"}, DG.Control.Traffic.Dictionary.es = {button_title: "Taco"}, DG.Control.Traffic.Dictionary.en = {button_title: "Traffic"}, DG.Control.Traffic.Dictionary.ar = {button_title: "حركة السير"}, DG.Ruler = DG.Layer.extend({
                        options: {editable: !0},
                        includes: [DG.Locale],
                        statics: {Dictionary: {}},
                        initialize: function (t, e) {
                        ...
                        spliceLatLngs: function (t) {
                            var e = this._points.length, i = 0 <= t ? Math.min(t, e) : e - t,
                        ...
                        _reset: function () {
                            DG.extend(this, {_lineMarkerHelper: null, _morphingNow: !1})
                        },
                        _lineMouseEvents: {
                            click: function (t) {
                                var e = t.layer;
                                if (e instanceof DG.Marker && e._pos !== this._points.length - 1) this._lineMarkerHelper && this._lineMarkerHelper.collapse(), e.setText(this._getFormatedDistance(e)), this._lineMarkerHelper = e; else if (e instanceof DG.Path && this.options.editable) {
                                    var i = t.latlng, o = e._point._pos + 1;
                                    this.spliceLatLngs(o, 0, i)
                                }
                            }, mouseover: function (t) {
                                var e = t.layer;
                                if (e._hovered = !0, !this._morphingNow) if (e instanceof DG.Marker && e._pos !== this._points.length - 1) e.setText(this._getFormatedDistance(e)); else if (e instanceof DG.Path && !this._lineMarkerHelper) {
                                    var i = e._point;
                                    this._lineMarkerHelper = this._addRunningLabel(this._nearestPoint(i._legs.middle, t.latlng), i)
                                }
                            }, mouseout: function (t) {
                                var e = t.layer, i = t.originalEvent;
                                ...
                                if (!this._morphingNow && this._lineMarkerHelper) {
                                    var e = t.layer._point, i = this._nearestPoint(e._legs.middle, t.latlng);
                        ...
                        _insertPointInLine: function (t) {
                            var e, i = this._lineMarkerHelper.getLatLng(), o = t.target._point._pos + 1;
                            if (L.Browser.ie) {
                        ...
                        _createPoint: function (e, t) {
                            var i = t || this.options.iconStyles.large, o = {};
                            return Object.keys(i).forEach(function (t) {
                        ...
                        _normalizeRulerPoints: function (t) {
                            t = t || this._points[0];
                            var e, i, o, n, r, s = this, a = t._pos, l = [];
                        ...
                        _deletePoint: function (t) {
                            var e = t.originalEvent, i = e.target || e.srcElement;
                        ...
                        _calcAngle: function (t, e, i) {
                            ...
                            var o = e.x - t.x, n = i.x - t.x, r = e.y - t.y, s = i.y - t.y, a = o * n + r * s,
                                l = Math.sqrt(o * o + r * r), u = Math.sqrt(n * n + s * s);
                            return Math.acos(a / (l * u))
                        },
                        _calcMidPoint: function (t, e) {
                            var i = this._degToRad(t.lng), o = this._degToRad(t.lat), n = this._degToRad(e.lng),
                                r = this._degToRad(e.lat),
                                s = Math.acos(Math.sin(o) * Math.sin(r) + Math.cos(o) * Math.cos(r) * Math.cos(i - n)),
                                a = Math.sin(.5 * s) / Math.sin(s), l = Math.sin(.5 * s) / Math.sin(s),
                                u = a * Math.cos(o) * Math.cos(i) + l * Math.cos(r) * Math.cos(n),
                                c = a * Math.cos(o) * Math.sin(i) + l * Math.cos(r) * Math.sin(n),
                                h = a * Math.sin(o) + l * Math.sin(r), d = Math.atan2(h, Math.sqrt(u * u + c * c)),
                                p = Math.atan2(c, u);
                        ...
                        _adaptiveSample: function (t, e, i, o) {
                            ...
                            var n = this._calcMidPoint(t, o), r = this._calcMidPoint(o, e),
                                s = this._calcAngle(n, o, t), a = this._calcAngle(o, t, e),
                        ...
                        _updateLegs: function (e, t) {
                            var i, o = e.getLatLng(), n = this._points[e._pos - 1], r = this._points[e._pos + 1];
                        ...
                        _getFormatedDistance: function () {
                            var t = this._calcDistance.apply(this, arguments), e = "m";
                        ...
                        }, statics: {domClass: "dg-ruler__label"}, addTo: function (t, e) {
                    ...
                    var rulerRenderer = DG.svg({pane: "rulerPane"}), hoverRenderer = DG.svg({pane: "rulerPane"});

                    function i1(t, e) {
                        return t.s(e.get(["purpose"], !1), e, {block: j1}, {}).s(e.get(["address"], !1), e, {block: k1}, {}).s(e.get(["description"], !1), e, {block: n1}, {})
                    }
                    ...
                    function k1(t, e) {
                        return t.w('<address class="dg-map-geoclicker__address">').s(e.getPath(!1, ["address", "header"]), e, {block: l1}, {}).s(e.getPath(!1, ["address", "drilldown"]), e, {block: m1}, {}).w("</address>")
                    }
                    ...
                    function n1(t, e) {
                        return t.w('<div class="dg-map-geoclicker__sight-description">').f(e.getPath(!0, []), e, "h").w("</div>").s(e.get(["showMoreText"], !1), e, {block: o1}, {})
                    }
                    ...
                    function b1(t, e) {
                        return t.s(e.get(["title"], !1), e, {block: c1}, {})
                    }
                    ...
                    function K0(t, e) {
                        return t.x(e.get(["btns"], !1), e, {block: L0}, {})
                    }

                    function L0(t, e) {
                        return t.w('<footer class="dg-popup__footer-buttons">').s(e.get(["btns"], !1), e, {block: M0}, {}).w("</footer>")
                    }

                    function M0(t, e) {
                        return t.w('<div class="dg-popup__footer-button-wrapper"><a class="dg-popup__button_name_').f(e.get(["name"], !1), e, "h").w(" dg-popup__footer-button").x(e.get(["icon"], !1), e, {block: N0}, {}).w('"').x(e.get(["href"], !1), e, {
                            else: O0,
                            block: P0
                    ...
                    function t0(t, e) {
                        return t.w('<div class="dg-preloader dg-preloader_scheme_regular dg-preloader_animation_').x(e.get(["anim"], !1), e, {
                            ...
                            block: v0
                        }, {}).x(e.get(["small"], !1), e, {block: w0}, {}).w('"></div>')
                    }
                    ...
                    function a0(t, e) {
                        return t.s(e.get(["address"], !1), e, {block: b0}, {}).s(e.get(["purpose"], !1), e, {block: e0}, {}).s(e.get(["attractions"], !1), e, {block: f0}, {})
                    }

                    function b0(t, e) {
                        return t.w('<address class="dg-map-geoclicker__address">').s(e.getPath(!1, ["address", "header"]), e, {block: c0}, {}).s(e.getPath(!1, ["address", "drilldown"]), e, {block: d0}, {}).w("</address>")
                    }
                    ...
                    function S_(t, e) {
                        return t.x(e.get(["payments"], !1), e, {block: T_}, {})
                    }

                    function T_(t, e) {
                        return t.w('<section class="dg-firm-card__aa"><ul class="dg-firm-card__aa-list">').s(e.get(["payments"], !1), e, {block: U_}, {}).w("</ul></section>")
                    }
                    ...
                    function QZ(t, e) {
                        return t.w('<div class="dg-firm-card__schedule dg-schedule dg-schedule_open_').x(e.getPath(!1, ["forecast", "open"]), e, {
                            ...
                            block: UZ
                        }, {}).w('">').x(e.get(["schedule"], !1), e, {block: VZ}, {}).w("</div>")
                    }
                    ...
                    function VZ(t, e) {
                        return t.x(e.getPath(!1, ["forecast", "today"]), e, {block: WZ}, {}).s(e.getPath(!1, ["forecast", "now"]), e, {block: $Z}, {}).nx(e.getPath(!1, ["schedule", "everyday"]), e, {block: a$}, {})
                    }

                    function WZ(t, e) {
                        return t.w('<div class="dg-schedule__today"><div class="dg-schedule__today-inner">').f(e.getPath(!1, ["forecast", "today", "text"]), e, "h").w("&nbsp;").x(e.getPath(!1, ["forecast", "today", "from"]), e, {block: XZ}, {}).x(e.getPath(!1, ["schedule", "lunch"]), e, {block: YZ}, {}).w("</div></div>")
                    }
                    ...
                    function YZ(t, e) {
                        return t.w(",&nbsp;").f(e.getPath(!1, ["forecast", "today", "lunchStr"]), e, "h").w("&nbsp;").s(e.getPath(!1, ["schedule", "lunch"]), e, {block: ZZ}, {})
                    }
                    ...
                    function $Z(t, e) {
                        return t.w('<div class="dg-schedule__now"><span class="dg-schedule__now-text">').f(e.getPath(!0, []), e, "h").s(e.getPath(!1, ["schedule", "comment"]), e, {block: _Z}, {}).w("</span></div>")
                    }
                    ...
                    function a$(t, e) {
                        return t.x(e.getPath(!1, ["schedule", "week"]), e, {block: b$}, {})
                    }

                    function b$(t, e) {
                        return t.x(e.getPath(!1, ["schedule", "week", "evently"]), e, {block: c$}, {}).x(e.getPath(!1, ["schedule", "week", "table"]), e, {block: k$}, {})
                    }

                    function c$(t, e) {
                        return t.w('<div class="dg-schedule__table">').s(e.getPath(!1, ["schedule", "week", "evently"]), e, {block: d$}, {}).w("</div>")
                    }

                    function d$(t, e) {
                        return t.w('<div class="dg-schedule__string">').x(e.get(["alltime"], !1), e, {block: e$}, {}).x(e.get(["everyday"], !1), e, {
                            else: f$,
                            block: g$
                        }, {}).x(e.get(["holiday"], !1), e, {else: h$, block: j$}, {}).w("</div>")
                    }
                    ...
                    function h$(t, e) {
                        return t.w('<span class="schedule__string-time">&nbsp;').f(e.get(["from"], !1), e, "h").w("&ndash;").f(e.get(["to"], !1), e, "h").w("</span>").s(e.get(["lunch"], !1), e, {block: i$}, {})
                    }
                    ...
                    function k$(t, e) {
                        return t.w('<div><div class="dg-schedule__table"><div class="dg-schedule__tc dg-schedule__tc_pre"><div class="dg-schedule__day-name">&nbsp;</div><div class="dg-schedule__table-clock dg-schedule__td"></div>').x(e.getPath(!1, ["schedule", "week", "hasLunch"]), e, {block: l$}, {}).w("</div>").s(e.getPath(!1, ["schedule", "week", "table"]), e, {block: m$}, {}).w("</div>  </div>")
                    }
                    ...
                    function m$(t, e) {
                        return t.h("if", e, {block: n$}, {cond: o$}, "h").w('<div class="dg-schedule__tc').x(e.get(["active"], !1), e, {block: p$}, {}).w('"><div class="dg-schedule__day-name">').f(e.get(["key"], !1), e, "h").w('</div><div class="dg-schedule__td">').x(e.get(["from"], !1), e, {
                            else: q$,
                            block: r$
                        }, {}).w("</div>").s(e.get(["lunch"], !1), e, {block: s$}, {}).w("</div> ").h("if", e, {block: v$}, {cond: w$}, "h")
                    }
                    ...
                    function xZ(t, e) {
                        return t.s(e.get(["rubrics"], !1), e, {block: yZ}, {})
                    }

                    function yZ(t, e) {
                        return t.w('<section class="dg-firm-card__rubrics">').x(e.get(["primary"], !1), e, {block: zZ}, {}).x(e.get(["additional"], !1), e, {block: BZ}, {}).w("</section>")
                    }

                    function zZ(t, e) {
                        return t.w('<ul class="dg-firm-card__rubrics-list dg-firm-card__rubrics-list_type_primary">').s(e.get(["primary"], !1), e, {block: AZ}, {}).w("</ul>")
                    }
                    ...
                    function BZ(t, e) {
                        return t.w('<ul class="dg-firm-card__rubrics-list dg-firm-card__rubrics-list_type_additional">').s(e.get(["additional"], !1), e, {block: CZ}, {}).w("</ul>")
                    }
                    ...
                    function $Y(t, e) {
                        return t.w('<div class="dg-popup__header-title dg-popup__header-title_for_firmcard" title="').f(e.get(["firmName"], !1), e, "h").w('">').f(e.get(["firmName"], !1), e, "h").w("</div>").x(e.get(["links"], !1), e, {block: _Y}, {})
                    }

                    function _Y(t, e) {
                        return t.w('<div class="dg-popup__header-links">').s(e.get(["links"], !1), e, {block: aZ}, {}).w("</div>")
                    }

                    function aZ(t, e) {
                        return t.h("eq", e, {else: bZ, block: eZ}, {key: fZ, value: "flamp_stars", type: "string"}, "h")
                    }
                    ...
                    function vY(t, e) {
                        return t.s(e.get(["groups"], !1), e, {block: wY}, {})
                    }

                    function wY(t, e) {
                        return t.s(e.get(["contacts"], !1), e, {block: xY}, {})
                    }

                    function xY(t, e) {
                        return t.h("select", e, {block: yY}, {key: e.get(["type"], !1), type: "string"}, "h")
                    }

                    function yY(t, e) {
                        return t.h("eq", e, {block: zY}, {
                            value: "phone",
                            type: "string"
                        }, "h").h("eq", e, {block: BY}, {
                            value: "fax",
                            ...
                            value: "website",
                            type: "string"
                        }, "h").h("eq", e, {block: EY}, {value: "email", type: "string"}, "h")
                    }

                    function zY(t, e) {
                        return t.w('<div class="dg-firm-card__phone dg-firm-card__icon"><span class="dg-firm-card__phone-num">').f(e.get(["text"], !1), e, "h").s(e.get(["comment"], !1), e, {block: AY}, {}).w("</span></div>")
                    }
                    ...
                    function BY(t, e) {
                        return t.w('<div class="dg-firm-card__phone dg-firm-card__icon"><span class="dg-firm-card__phone-num">').f(e.get(["text"], !1), e, "h").s(e.get(["comment"], !1), e, {block: CY}, {}).w("</span></div>")
                    }
                    ...
                    function oY(t, e) {
                        return t.w('<address class="dg-firm-card__address dg-firm-card__icon">').f(e.get(["address"], !1), e, "h").s(e.get(["comment"], !1), e, {block: pY}, {}).w("</address>")
                    }
                    ...
                    function hY(t, e) {
                        return t.w('<div class="dg-map-geoclicker__purpose dg-map-geoclicker__purpose_type_').f(e.get(["type"], !1), e, "h").w('">').f(e.get(["purpose"], !1), e, "h").w("</div>").s(e.get(["drilldown"], !1), e, {block: iY}, {})
                    }
                    ...
                    }), DG.Ruler.Dictionary.ru = {km: "км", m: "м", delimiter: ","}, DG.Ruler.Dictionary.it = {
                        km: "km",
                        m: "m",
                        delimiter: ","
                    }, DG.Ruler.Dictionary.cs = {km: "km", m: "m", delimiter: ","}, DG.Ruler.Dictionary.es = {
                        km: "km",
                        m: "m",
                        delimiter: ","
                    }, DG.Ruler.Dictionary.en = {km: "km", m: "m", delimiter: "."}, DG.Ruler.Dictionary.ar = {
                        km: "كم",
                        m: "م",
                        delimiter: "."
                    }, DG.Control.Ruler = DG.RoundControl.extend({
                        options: {position: "topright", iconClass: "ruler"},
                        statics: {Dictionary: {}},
                        initialize: function (t) {
                ...
                function s(t, e) {
                    var i = document.head || document.getElementsByTagName("head")[0], o = n[n.length - 1];
                    if ((e = e || {}).insertAt = e.insertAt || "bottom", "top" === e.insertAt) o ? o.nextSibling ? i.insertBefore(t, o.nextSibling) : i.appendChild(t) : i.insertBefore(t, i.firstChild), n.push(t); else {
                ...
                e.exports = {
                    createLink: function (t, e) {
                        ...
                        for (var n in o.href = t, o.rel = "stylesheet", e) if (e.hasOwnProperty(n)) {
                            var r = e[n];
                        ...
                        for (var n in o.type = "text/css", e) if (e.hasOwnProperty(n)) {
                            var r = e[n];
                            o.setAttribute("data-" + n, r)
                        }
                        o.sheet ? (o.innerHTML = t, o.sheet.cssText = t, s(o, {insertAt: i.insertAt})) : o.styleSheet ? (s(o, {insertAt: i.insertAt}), o.styleSheet.cssText = t) : (o.appendChild(document.createTextNode(t)), s(o, {insertAt: i.insertAt}))
                    }
                }
            }, {}], 4: [function (t, e, i) {
                var o, n;
                o = this, n = function (a) {
                    ...
                    function u(t, e) {
                        var i, o = t.stack.head, n = t.rebase();
                        t.stack && t.stack.tail && (n.stack = t.stack.tail);
                        var r = {isPending: !1, isResolved: !1, isDeferredComplete: !1, deferreds: []};
                        for (i in e) r[i] = e[i];
                        return n.push({__select__: r}).push(o, t.stack.index, t.stack.of)
                    }

                    function c(t) {
                        var e, i;
                        if (t.isDeferredPending = !0, t.deferreds.length) for (t.isDeferredComplete = !0, e = 0, i = t.deferreds.length; e < i; e++) t.deferreds[e]();
                    ...
                    function t(n, r) {
                        return function (t, e, i, o) {
                            return function (t, e, i, o, n, r) {
                                var s, a, l, u, c = i.block, h = i.else, d = _(e) || {};
                                if (d.isResolved && !d.isDeferredPending) return t;
                                if (o.hasOwnProperty("key")) a = o.key; else {
                    ...
                    var o = {}, e = {
                        tap: function (t, e, i) {
                            ...
                            var n, r = o.key, s = o.method, a = o.operand, l = o.round;
                            ...
                            return void 0 !== n && (l && (n = Math.round(n)), i && i.block ? (e = u(e, {key: n}), t = t.render(i.block, e), c(_(e))) : t = t.write(n)), t
                            ...
                            var n, r, s = o.key;
                            if ((s = e.resolve(o.key)) && !0 !== s) if (a.isArray(s)) n = s.length; else if (!isNaN(parseFloat(s)) && isFinite(s)) n = s; else if ("object" == typeof s) for (r in n = 0, s) s.hasOwnProperty(r) && n++; else n = (s + "").length; else n = 0;
                            return t.write(n)
                        }
                    };
                ...
                (function (process) {
                    ...
                    m4 = this, n4 = function () {
                        ...
                        var dust = {version: "2.7.5"}, NONE = "NONE", ERROR = "ERROR", WARN = "WARN", INFO = "INFO",
                            DEBUG = "DEBUG", EMPTY_FUNC = function () {
                            }, T4, U4, V4;
                        for (var f in dust.config = {
                            ...
                            for (e in t) if (Object.prototype.hasOwnProperty.call(t, e)) return !1;
                            return !0
                            ...
                            var n, r, s, a;
                            if (i) for (n = 0, r = i.length; n < r; n++) (s = i[n]).length && (a = dust.filters[s], "s" === s ? e = null : "function" == typeof a ? t = a(t, o) : dust.log("Invalid filter `" + s + "`", WARN));
                            ...
                            }, u: encodeURI, uc: encodeURIComponent, js: function (t) {
                            ...
                            var i, o, n, r, s, a = this.stack || {}, l = 1;
                            if (o = e[0], n = e.length, t && 0 === n) a = (r = a).head; else {
                                if (t) a = a && (a.head ? a.head[o] : void 0); else {
                            ...
                            for (i = e.length; i--;) if (o = e[i][t]) return o;
                            ...
                            var i = this.events = this.events || {}, o = i[t] = i[t] || [];
                            ...
                            var e = new Chunk(this.root, this.next, this.taps), i = new Chunk(this.root, e, this.taps);
                            ...
                            var n, r, s, a = i.block, l = i.else, u = this;
                ...
                !function (t, s) {
                    ...
                    function n(t) {
                        ...
                        return !_.shivCSS || i || e.hasCSS || (e.hasCSS = !!function (t, e) {
                            var i = t.createElement("p"), o = t.getElementsByTagName("head")[0] || t.documentElement;
                ...
                function l(t) {
                    var e = +new Date, i = Math.max(0, 16 - (e - o));
                ...
                "object" == typeof e && "object" == typeof e.exports ? e.exports = b : "function" == typeof define && define.amd && define(b), "undefined" != typeof window && (s = window.L, b.noConflict = function () {
                    ...
                    t && r.call(window, t)
                }, b.extend = b.Util.extend, b.bind = b.Util.bind, b.stamp = b.Util.stamp, b.setOptions = b.Util.setOptions, b.Class = function () {
                }, b.Class.extend = function (t) {
                    function e() {
                        this.initialize && this.initialize.apply(this, arguments), this.callInitHooks()
                    }

                    var i = e.__super__ = this.prototype, o = b.Util.create(i);
                    ...
                    on: function (t, e, i) {
                        if ("object" == typeof t) for (var o in t) this._on(o, t[o], e); else for (var n = 0, r = (t = b.Util.splitWords(t)).length; n < r; n++) this._on(t[n], e, i);
                        return this
                    }, off: function (t, e, i) {
                        if (t) if ("object" == typeof t) for (var o in t) this._off(o, t[o], e); else for (var n = 0, r = (t = b.Util.splitWords(t)).length; n < r; n++) this._off(t[n], e, i); else delete this._events;
                        return this
                    }, _on: function (t, e, i) {
                        ...
                        for (var n = {
                            fn: e,
                            ctx: i
                        }, r = o, s = 0, a = r.length; s < a; s++) if (r[s].fn === e && r[s].ctx === i) return;
                        r.push(n), o.count++
                    }, _off: function (t, e, i) {
                        var o, n, r;
                        if (this._events && (o = this._events[t])) {
                            ...
                            if (i === this && (i = void 0), o) for (n = 0, r = o.length; n < r; n++) {
                                var s = o[n];
                        ...
                        var o = b.Util.extend({}, e, {type: t, target: this});
                        if (this._events) {
                        ...
                        for (var e in this._eventParents) this._eventParents[e].fire(t.type, b.extend({layer: t.target}, t), !0)
                    }
                });
                ...
                G.addEventListener = G.on, G.removeEventListener = G.clearAllEventListeners = G.off, G.addOneTimeEventListener = G.once, G.fireEvent = G.fire, G.hasEventListeners = G.listens, b.Mixin = {Events: G}, p = navigator.userAgent.toLowerCase(), _ = document.documentElement, m = "ActiveXObject" in window, f = -1 !== p.indexOf("webkit"), g = -1 !== p.indexOf("phantom"), v = -1 !== p.search("android [23]"), y = -1 !== p.indexOf("chrome"), C = -1 !== p.indexOf("gecko") && !f && !window.opera && !m, w = 0 === navigator.platform.indexOf("Win"), x = "undefined" != typeof orientation || -1 !== p.indexOf("mobile"), k = !window.PointerEvent && window.MSPointerEvent, D = window.PointerEvent || k, L = m && "transition" in _.style, z = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !v, P = "MozPerspective" in _.style, E = "OTransition" in _.style, T = !window.L_NO_TOUCH && (D || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch), b.Browser = {
                    ...
                    clone: function () {
                        ...
                        var e = (t = b.point(t)).x - this.x, i = t.y - this.y;
                    ...
                    extend: function (t) {
                        ...
                        t = b.bounds(t);
                        var e = this.min, i = this.max, o = t.min, n = t.max, r = n.x >= e.x && o.x <= i.x,
                            s = n.y >= e.y && o.y <= i.y;
                        return r && s
                    }, overlaps: function (t) {
                        t = b.bounds(t);
                    ...
                    get: function (t) {
                        ...
                        if (void 0 !== t.classList) for (var i = b.Util.splitWords(e), o = 0, n = i.length; o < n; o++) t.classList.add(i[o]); else if (!b.DomUtil.hasClass(t, e)) {
                    ...
                    extend: function (t) {
                        ...
                        if (t instanceof b.LatLng) i = e = t; else {
                        ...
                        var e = this._southWest, i = this._northEast, o = Math.abs(e.lat - i.lat) * t,
                        ...
                        t = b.latLngBounds(t);
                        var e = this._southWest, i = this._northEast, o = t.getSouthWest(), n = t.getNorthEast(),
                            r = n.lat >= e.lat && o.lat <= i.lat, s = n.lng >= e.lng && o.lng <= i.lng;
                        return r && s
                    }, overlaps: function (t) {
                        t = b.latLngBounds(t);
                        var e = this._southWest, i = this._northEast, o = t.getSouthWest(), n = t.getNorthEast(),
                    ...
                    R: 6378137, MAX_LATITUDE: 85.0511287798, project: function (t) {
                        var e = Math.PI / 180, i = this.MAX_LATITUDE, o = Math.max(Math.min(i, t.lat), -i),
                            n = Math.sin(o * e);
                    ...
                    latLngToPoint: function (t, e) {
                        ...
                        var e = this.projection.bounds, i = this.scale(t), o = this.transformation.transform(e.min, i),
                        ...
                        var e = this.wrapLng ? b.Util.wrapNum(t.lng, this.wrapLng, !0) : t.lng,
                            i = this.wrapLat ? b.Util.wrapNum(t.lat, this.wrapLat, !0) : t.lat, o = t.alt;
                    ...
                    wrapLng: [-180, 180], R: 6371e3, distance: function (t, e) {
                        var i = Math.PI / 180, o = t.lat * i, n = e.lat * i,
                ...
                }), b.CRS.EPSG900913 = b.extend({}, b.CRS.EPSG3857, {code: "EPSG:900913"}), b.CRS.EPSG4326 = b.extend({}, b.CRS.Earth, {
                    code: "EPSG:4326",
                    projection: b.Projection.LonLat,
                    ...
                    options: {
                        ...
                        var o = this.getZoomScale(e), n = this.getSize().divideBy(2),
                        ...
                        var r = o.subtract(i).divideBy(2), s = this.project(t.getSouthWest(), n),
                            a = this.project(t.getNorthEast(), n);
                        return {center: this.unproject(s.add(a).divideBy(2).add(r), n), zoom: n}
                        ...
                        var i = this.getCenter(), o = this._limitCenter(i, this._zoom, b.latLngBounds(t));
                        return i.equals(o) || this.panTo(o, e), this._enforcingBounds = !1, this
                    }, invalidateSize: function (t) {
                        if (!this._loaded) return this;
                        t = b.extend({animate: !1, pan: !0}, !0 === t ? {animate: !0} : t);
                        var e = this.getSize();
                        this._sizeChanged = !0, this._lastCenter = null;
                        var i = this.getSize(), o = e.divideBy(2).round(), n = i.divideBy(2).round(), r = o.subtract(n);
                        ...
                        var o = this.getZoom() || 0, n = this.getMinZoom(), r = this.getMaxZoom(), s = t.getNorthWest(),
                            a = t.getSouthEast(), l = this.getSize().subtract(i),
                            u = this.project(a, o).subtract(this.project(s, o)),
                            c = b.Browser.any3d ? this.options.zoomSnap : 1, h = Math.min(l.x / u.x, l.y / u.y);
                        ...
                        if (!t._stopped && (i = (i || []).concat(this._findEventTargets(t, e))).length) {
                            ...
                            for (var a = 0; a < i.length; a++) if (i[a].fire(e, r, !0), r.originalEvent._stopped || i[a].options.nonBubblingEvents && -1 !== b.Util.indexOf(i[a].options.nonBubblingEvents, e)) return
                        }
                        ...
                        if (!i) return t;
                        var o = this.project(t, e), n = this.getSize().divideBy(2),
                            r = new b.Bounds(o.subtract(n), o.add(n)), s = this._getBoundsOffset(r, i, e);
                        return s.round().equals([0, 0]) ? t : this.unproject(o.add(s), e)
                    }, _limitOffset: function (t, e) {
                        if (!e) return t;
                        var i = this.getPixelBounds(), o = new b.Bounds(i.min.add(t), i.max.add(t));
                        return t.add(this._getBoundsOffset(o, e))
                    }, _getBoundsOffset: function (t, e, i) {
                        var o = b.bounds(this.project(e.getNorthEast(), i), this.project(e.getSouthWest(), i)),
                            n = o.min.subtract(t.min), r = o.max.subtract(t.max), s = this._rebound(n.x, -r.x),
                    ...
                    project: function (t) {
                        var e = Math.PI / 180, i = this.R, o = t.lat * e, n = this.R_MINOR / i,
                            r = Math.sqrt(1 - n * n), s = r * Math.sin(o),
                    ...
                    options: {
                        ...
                        var n = Math.floor(t / 2), r = Math.floor(e / 2), s = i - 1, a = new b.Point(+n, +r);
                        a.z = +s;
                        ...
                        for (var n = 2 * t; n < 2 * t + 2; n++) for (var r = 2 * e; r < 2 * e + 2; r++) {
                        ...
                        var t = this._map, e = t.options.crs, i = this._tileSize = this.getTileSize(),
                            o = this._tileZoom, n = this._map.getPixelWorldBounds(this._tileZoom);
                        ...
                        var e = this._map, i = e._animatingZoom ? Math.max(e._animateToZoom, e.getZoom()) : e.getZoom(),
                            o = e.getZoomScale(i, this._tileZoom), n = e.project(t, this._tileZoom).floor(),
                        ...
                        var e = this._map, i = this.getTileSize(), o = t.scaleBy(i), n = o.add(i),
                            r = e.unproject(o, t.z), s = e.unproject(n, t.z);
                        return this.options.noWrap || (r = e.wrapLatLng(r), s = e.wrapLatLng(s)), new b.LatLngBounds(r, s)
                    }, _tileCoordsToKey: function (t) {
                        return t.x + ":" + t.y + ":" + t.z
                    }, _keyToTileCoords: function (t) {
                        var e = t.split(":"), i = new b.Point(+e[0], +e[1]);
                        return i.z = +e[2], i
                        ...
                        var i = this._getTilePos(t), o = this._tileCoordsToKey(t),
                        ...
                        this._initTile(n), this.createTile.length < 2 && b.Util.requestAnimFrame(b.bind(this._tileReady, this, t, null, n)), b.DomUtil.setPosition(n, i), this._tiles[o] = {
                            ...
                            coords: t,
                            current: !0
                        }, e.appendChild(n), this.fire("tileloadstart", {tile: n, coords: t})
                    }, _tileReady: function (t, e, i) {
                        if (this._map) {
                            e && this.fire("tileerror", {error: e, tile: i, coords: t});
                            var o = this._tileCoordsToKey(t);
                    ...
                    options: {
                        ...
                        var t = this._map, e = b.GridLayer.prototype.getTileSize.call(this),
                            i = this._tileZoom + this.options.zoomOffset, o = this.options.maxNativeZoom;
                    ...
                    options: {opacity: 1, alt: "", interactive: !1, attribution: null, crossOrigin: !1},
                    initialize: function (t, e, i) {
                    ...
                    options: {
                        ...
                        var t = this.options, e = "leaflet-zoom-" + (this._zoomAnimated ? "animated" : "hide"),
                            i = t.icon.createIcon(this._icon), o = !1;
                        ...
                        var n = t.icon.createShadow(this._shadow), r = !1;
                    ...
                    options: {offset: [0, 7], className: "", pane: "popupPane"}, initialize: function (t, e) {
                        ...
                        if (this._map) {
                            var t = this._map.latLngToLayerPoint(this._latlng), e = b.point(this.options.offset),
                                i = this._getAnchor();
                    ...
                    options: {
                        ...
                        b.DivOverlay.prototype.onAdd.call(this, t), t.fire("popupopen", {popup: this}), this._source && (this._source.fire("popupopen", {popup: this}, !0), this._source instanceof b.Path || this._source.on("preclick", b.DomEvent.stopPropagation))
                    }, onRemove: function (t) {
                        b.DivOverlay.prototype.onRemove.call(this, t), t.fire("popupclose", {popup: this}), this._source && (this._source.fire("popupclose", {popup: this}, !0), this._source instanceof b.Path || this._source.off("preclick", b.DomEvent.stopPropagation))
                    }, getEvents: function () {
                        ...
                        var o = t.offsetHeight, n = this.options.maxHeight, r = "leaflet-popup-scrolled";
                        ...
                        if (!(!this.options.autoPan || this._map._panAnim && this._map._panAnim._inProgress)) {
                            var t = this._map,
                                ...
                                i = this._container.offsetHeight + e, o = this._containerWidth,
                                n = new b.Point(this._containerLeft, -i - this._containerBottom);
                            n._add(b.DomUtil.getPosition(this._container));
                            var r = t.layerPointToContainerPoint(n), s = b.point(this.options.autoPanPadding),
                                a = b.point(this.options.autoPanPaddingTopLeft || s),
                                l = b.point(this.options.autoPanPaddingBottomRight || s), u = t.getSize(), c = 0, h = 0;
                ...
                }, b.Map.mergeOptions({closePopupOnClick: !0}), b.Map.include({
                    openPopup: function (t, e, i) {
                    ...
                    bindPopup: function (t, e) {
                        ...
                        if (t instanceof b.Layer || (e = t, t = this), t instanceof b.FeatureGroup) for (var i in this._layers) {
                            t = this._layers[i];
                            break
                        }
                    ...
                    options: {
                        ...
                        b.DivOverlay.prototype.onAdd.call(this, t), this.setOpacity(this.options.opacity), t.fire("tooltipopen", {tooltip: this}), this._source && this._source.fire("tooltipopen", {tooltip: this}, !0)
                    }, onRemove: function (t) {
                        b.DivOverlay.prototype.onRemove.call(this, t), t.fire("tooltipclose", {tooltip: this}), this._source && this._source.fire("tooltipclose", {tooltip: this}, !0)
                    }, getEvents: function () {
                        var t = b.DivOverlay.prototype.getEvents.call(this);
                        ...
                        var e = this._map, i = this._container, o = e.latLngToContainerPoint(e.getCenter()),
                            n = e.layerPointToContainerPoint(t), r = this.options.direction, s = i.offsetWidth,
                            a = i.offsetHeight, l = b.point(this.options.offset), u = this._getAnchor();
                    ...
                    addLayer: function (t) {
                        return this.hasLayer(t) ? this : (t.addEventParent(this), b.LayerGroup.prototype.addLayer.call(this, t), this.fire("layeradd", {layer: t}))
                    }, removeLayer: function (t) {
                        return this.hasLayer(t) ? (t in this._layers && (t = this._layers[t]), t.removeEventParent(this), b.LayerGroup.prototype.removeLayer.call(this, t), this.fire("layerremove", {layer: t})) : this
                    }, setStyle: function (t) {
                    ...
                    options: {padding: .1}, initialize: function (t) {
                        ...
                        var t = {viewreset: this._reset, zoom: this._onZoom, moveend: this._update};
                        ...
                        var i = this._map.getZoomScale(e, this._zoom), o = b.DomUtil.getPosition(this._container),
                    ...
                    getRenderer: function (t) {
                        ...
                        return void 0 === e && (e = b.SVG && b.svg({pane: t}) || b.Canvas && b.canvas({pane: t}), this._paneRenderers[t] = e), e
                    }
                    ...
                    simplify: function (t, e) {
                        ...
                        var i = t.length, o = new (typeof Uint8Array != void 0 + "" ? Uint8Array : Array)(i);
                        ...
                        var r, s, a, l = o ? this._lastCode : this._getBitCode(t, i), u = this._getBitCode(e, i);
                        ...
                        var r, s, a = e.x - t.x, l = e.y - t.y, u = o.min, c = o.max;
                        ...
                        var n, r = e.x, s = e.y, a = i.x - r, l = i.y - s, u = a * a + l * l;
                    ...
                    options: {smoothFactor: 1, noClip: !1}, initialize: function (t, e) {
                        ...
                        for (var e, i, o = 1 / 0, n = null, r = b.LineUtil._sqClosestPointOnSegment, s = 0, a = this._parts.length; s < a; s++) for (var l = this._parts[s], u = 1, c = l.length; u < c; u++) {
                        ...
                        var t, e, i, o, n, r, s, a = this._rings[0], l = a.length;
                        if (!l) return null;
                        for (e = t = 0; t < l - 1; t++) e += a[t].distanceTo(a[t + 1]) / 2;
                        if (0 === e) return this._map.layerPointToLatLng(a[0]);
                        for (o = t = 0; t < l - 1; t++) if (n = a[t], r = a[t + 1], e < (o += i = n.distanceTo(r))) return s = (o - e) / i, this._map.layerPointToLatLng([r.x - s * (r.x - n.x), r.y - s * (r.y - n.y)])
                    }, getBounds: function () {
                        return this._bounds
                        ...
                        var e = this._clickTolerance(), i = new b.Point(e, e);
                        this._bounds.isValid() && t.isValid() && (t.min._subtract(i), t.max._add(i), this._pxBounds = t)
                    }, _projectLatlngs: function (t, e, i) {
                        var o, n, r = t[0] instanceof b.LatLng, s = t.length;
                        if (r) {
                        ...
                        if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) {
                            ...
                            for (o = e = 0, n = this._rings.length; e < n; e++) for (i = 0, r = (a = this._rings[e]).length; i < r - 1; i++) (s = b.LineUtil.clipSegment(a[i], a[i + 1], t, i, !0)) && (l[o] = l[o] || [], l[o].push(s[0]), s[1] === a[i + 1] && i !== r - 2 || (l[o].push(s[1]), o++))
                        }
                    ...
                    var o, n, r, s, a, l, u, c, h, d = [1, 4, 2, 8], p = b.LineUtil;
                    ...
                    options: {fill: !0}, isEmpty: function () {
                        ...
                        if (!this._map) throw new Error("Must add layer to map before using getCenter()");
                        var t, e, i, o, n, r, s, a, l, u = this._rings[0], c = u.length;
                        if (!c) return null;
                        ...
                        var e = b.Polyline.prototype._convertLatLngs.call(this, t), i = e.length;
                        ...
                        var t = this._renderer._bounds, e = this.options.weight, i = new b.Point(e, e);
                    ...
                    options: {fill: !0, radius: 10}, initialize: function (t, e) {
                        ...
                        return this._latlng = b.latLng(t), this.redraw(), this.fire("move", {latlng: this._latlng})
                    }, getLatLng: function () {
                        return this._latlng
                    ...
                    initialize: function (t, e, i) {
                        if ("number" == typeof e && (e = b.extend({}, i, {radius: e})), b.setOptions(this, e), this._latlng = b.latLng(t), isNaN(this.options.radius)) throw new Error("Circle radius cannot be NaN");
                    ...
                    }, setStyle: b.Path.prototype.setStyle, _project: function () {
                        var t = this._latlng.lng, e = this._latlng.lat, i = this._map, o = i.options.crs;
                        if (o.distance === b.CRS.Earth.distance) {
                            var n = Math.PI / 180, r = this._mRadius / b.CRS.Earth.R / n, s = i.project([e + r, t]),
                                a = i.project([e - r, t]), l = s.add(a).divideBy(2), u = i.unproject(l).lat,
                    ...
                    getEvents: function () {
                        ...
                        var e = t._point, i = t._radius, o = "a" + i + "," + (t._radiusY || i) + " 0 1,0 ",
                    ...
                    _initContainer: function () {
                        ...
                        var e = t._stroke, i = t._fill, o = t.options, n = t._container;
                    ...
                    onAdd: function () {
                        ...
                        if (!this._map._animatingZoom || !this._bounds) {
                            ...
                            var t = this._bounds, e = this._container, i = t.getSize(), o = b.Browser.retina ? 2 : 1;
                    ...
                    }, _addPath: b.Util.falseFn, _removePath: function (t) {
                        ...
                        if (t.options.dashArray) {
                            var e, i = t.options.dashArray.split(","), o = [];
                        ...
                        var i, o, n, r, s = t._parts, a = s.length, l = this._ctx;
                        if (a) {
                        ...
                        if (!t._empty()) {
                            var e = t._point, i = this._ctx, o = t._radius, n = (t._radiusY || o) / o;
                        ...
                        var e, i = this._map.mouseEventToLayerPoint(t), o = [];
                    ...
                    }, _bringToFront: b.Util.falseFn, _bringToBack: b.Util.falseFn
                    ...
                    for (i = 0, r = this._parts.length; i < r; i++) for (o = 0, n = (s = (a = this._parts[i]).length) - 1; o < s; n = o++) if ((e || 0 !== o) && b.LineUtil.pointToSegmentDistance(t, a[n], a[o]) <= l) return !0;
                    return !1
                },b.Polygon.prototype._containsPoint = function (t) {
                    var e, i, o, n, r, s, a, l, u = !1;
                    if (!this._pxBounds.contains(t)) return !1;
                    for (n = 0, a = this._parts.length; n < a; n++) for (r = 0, s = (l = (e = this._parts[n]).length) - 1; r < l; s = r++) i = e[r], o = e[s], i.y > t.y != o.y > t.y && t.x < (o.x - i.x) * (t.y - i.y) / (o.y - i.y) + i.x && (u = !u);
                    ...
                    geometryToLayer: function (t, e) {
                        var i, o, n, r, s = "Feature" === t.type ? t.geometry : t, a = s ? s.coordinates : null, l = [],
                        ...
                        return t.feature ? b.extend({}, t.feature, {geometry: e}) : b.GeoJSON.asFeature(e)
                ...
                b.Marker.include(A), b.Circle.include(A), b.CircleMarker.include(A), b.Polyline.prototype.toGeoJSON = function () {
                    var t = !b.Polyline._flat(this._latlngs), e = b.GeoJSON.latLngsToCoords(this._latlngs, t ? 1 : 0);
                    return b.GeoJSON.getFeature(this, {type: (t ? "Multi" : "") + "LineString", coordinates: e})
                }, b.Polygon.prototype.toGeoJSON = function () {
                    var t = !b.Polyline._flat(this._latlngs), e = t && !b.Polyline._flat(this._latlngs[0]),
                    ...
                    toMultiPoint: function () {
                        ...
                        }), b.GeoJSON.getFeature(this, {type: "MultiPoint", coordinates: e})
                    }, toGeoJSON: function () {
                        var t = this.feature && this.feature.geometry && this.feature.geometry.type;
                        if ("MultiPoint" === t) return this.toMultiPoint();
                        var i = "GeometryCollection" === t, o = [];
                        return this.eachLayer(function (t) {
                            if (t.toGeoJSON) {
                                var e = t.toGeoJSON();
                ...
                b.DomEvent = {
                    on: function (t, e, i, o) {
                        if ("object" == typeof e) for (var n in e) this._on(t, n, e[n], i); else for (var r = 0, s = (e = b.Util.splitWords(e)).length; r < s; r++) this._on(t, e[r], i, o);
                        return this
                    },
                    off: function (t, e, i, o) {
                        if ("object" == typeof e) for (var n in e) this._off(t, n, e[n], i); else for (var r = 0, s = (e = b.Util.splitWords(e)).length; r < s; r++) this._off(t, e[r], i, o);
                        return this
                    },
                    ...
                    _off: function (t, e, i, o) {
                        var n = e + b.stamp(i) + (o ? "_" + b.stamp(o) : ""), r = t[M] && t[M][n];
                    ...
                    _onUp: function (t) {
                        if (!t._simulated && this._enabled) {
                            ...
                            b.DomUtil.enableImageDrag(), b.DomUtil.enableTextSelection(), this._moved && this._moving && (b.Util.cancelAnimFrame(this._animRequest), this.fire("dragend", {distance: this._newPos.distanceTo(this._startPos)})), this._moving = !1, b.Draggable._dragging = !1
                        }
                    }
                    ...
                    addHooks: function () {
                        ...
                        var t = this._worldWidth, e = Math.round(t / 2), i = this._initialWorldOffset,
                            o = this._draggable._newPos.x, n = (o - e + i) % t + e - i, r = (o + e + i) % t - e - i,
                        ...
                        if (e.fire("dragend", t), o) e.fire("moveend"); else {
                            var n = this._lastPos.subtract(this._positions[0]),
                                r = (this._lastTime - this._times[0]) / 1e3, s = i.easeLinearity,
                                a = n.multiplyBy(s / r), l = a.distanceTo([0, 0]), u = Math.min(i.inertiaMaxSpeed, l),
                                c = a.multiplyBy(u / l), h = u / (i.inertiaDeceleration * s),
                ...
                }), b.Map.addInitHook("addHandler", "dragging", b.Map.Drag), b.Map.mergeOptions({doubleClickZoom: !0}), b.Map.DoubleClickZoom = b.Handler.extend({
                    addHooks: function () {
                        this._map.on("dblclick", this._onDoubleClick, this)
                    }, removeHooks: function () {
                        this._map.off("dblclick", this._onDoubleClick, this)
                    }, _onDoubleClick: function (t) {
                        var e = this._map, i = e.getZoom(), o = e.options.zoomDelta,
                    ...
                    addHooks: function () {
                        ...
                        var e = b.DomEvent.getWheelDelta(t), i = this._map.options.wheelDebounceTime;
                        ...
                        var o = this._delta / (4 * this._map.options.wheelPxPerZoomLevel),
                            ...
                            r = i ? Math.ceil(n / i) * i : n, s = t._limitZoom(e + (0 < this._delta ? r : -r)) - e;
                    ...
                    setView: function (t, e, i) {
                        if ((e = void 0 === e ? this._zoom : this._limitZoom(e), t = this._limitCenter(b.latLng(t), e, this.options.maxBounds), i = i || {}, this._stop(), this._loaded && !i.reset && !0 !== i) && (void 0 !== i.animate && (i.zoom = b.extend({animate: i.animate}, i.zoom), i.pan = b.extend({
                            animate: i.animate,
                            duration: i.duration
                        }, i.pan)), this._zoom !== e ? this._tryAnimatedZoom && this._tryAnimatedZoom(t, e, i.zoom) : this._tryAnimatedPan(t, i.pan))) return clearTimeout(this._sizeTimer), this;
                        return this._resetView(t, e), this
                ...
                O && b.Map.addInitHook(function () {
                    ...
                    _createAnimProxy: function () {
                        ...
                        this._panes.mapPane.appendChild(o), this.on("zoomanim", function (t) {
                            var e = b.DomUtil.TRANSFORM, i = o.style[e];
                        ...
                        var o = this.getZoomScale(e), n = this._getCenterOffset(t)._divideBy(1 - 1 / o);
                    ...
                    flyTo: function (o, n, t) {
                        ...
                        this._stop();
                        var a = this.project(this.getCenter()), l = this.project(o), u = this.getSize(), c = this._zoom;
                        o = b.latLng(o), n = void 0 === n ? c : n;
                        var h = Math.max(u.x, u.y), d = h * this.getZoomScale(c, n), p = l.distanceTo(a) || 1, _ = 1.42,
                            m = _ * _, f = e(0), g = Date.now(), v = (e(1) - f) / _,
                            y = t.duration ? 1e3 * t.duration : 1e3 * v * .8;
                        return this._moveStart(!0), function t() {
                            var e = (Date.now() - g) / y, i = function (t) {
                            ...
                            }(i), c), {flyTo: !0})) : this._move(o, n)._moveEnd(!0)
                        }.call(this), this
                    ...
                    addDoubleTapListener: function (t, o, e) {
                        ...
                        var r, s, a = !1, l = "_leaflet_", u = this._touchstart, c = this._touchend;
                    ...
                    removeDoubleTapListener: function (t, e) {
                        var i = "_leaflet_", o = t[i + this._touchstart + e], n = t[i + this._touchend + e],
                            r = t[i + "dblclick" + e];
                    ...
                    addHooks: function () {
                        ...
                        if (t.touches && 2 === t.touches.length && this._zooming) {
                            var e = this._map, i = e.mouseEventToContainerPoint(t.touches[0]),
                                o = e.mouseEventToContainerPoint(t.touches[1]), n = i.distanceTo(o) / this._startDist;
                            ...
                            var s = b.bind(e._move, e, this._center, this._zoom, {pinch: !0, round: !1});
                ...
                }), b.Browser.touch && !b.Browser.pointer && b.Map.addInitHook("addHandler", "tap", b.Map.Tap), b.Map.mergeOptions({boxZoom: !0}), b.Map.BoxZoom = b.Handler.extend({
                    initialize: function (t) {
                        ...
                        var e = new b.Bounds(this._point, this._startPoint), i = e.getSize();
                    ...
                    keyCodes: {
                        ...
                        if (!(t.altKey || t.ctrlKey || t.metaKey)) {
                            ...
                            } else if (i in this._zoomKeys) o.setZoom(o.getZoom() + (t.shiftKey ? 3 : 1) * this._zoomKeys[i]); else {
                                if (27 !== i) return;
                                o.closePopup()
                            }
                            b.DomEvent.stop(t)
                    ...
                    initialize: function (t) {
                        ...
                        var e = this._marker, i = e._shadow, o = b.DomUtil.getPosition(e._icon),
                    ...
                    addControl: function (t) {
                        ...
                        var o = this._controlCorners = {}, n = "leaflet-",
                    ...
                    options: {
                        ...
                        var e = "leaflet-control-zoom", i = b.DomUtil.create("div", e + " leaflet-bar"),
                            o = this.options;
                ...
                }), b.Map.mergeOptions({zoomControl: !0}), b.Map.addInitHook(function () {
                ...
                }), b.Map.mergeOptions({attributionControl: !0}), b.Map.addInitHook(function () {
                    ...
                    options: {position: "bottomleft", maxWidth: 100, metric: !0, imperial: !0}, onAdd: function (t) {
                        var e = "leaflet-control-scale", i = b.DomUtil.create("div", e), o = this.options;
                    ...
                    _initLayout: function () {
                        var t = "leaflet-control-layers", e = this._container = b.DomUtil.create("div", t);
                    ...
                    _getLayer: function (t) {
                        for (var e = 0; e < this._layers.length; e++) if (this._layers[e] && b.stamp(this._layers[e].layer) === t) return this._layers[e]
                    },
                    ...
                    _onInputClick: function () {
                        var t, e, i, o = this._form.getElementsByTagName("input"), n = [], r = [];
                    ...
                    _defaultLocateOptions: {timeout: 1e4, watch: !1}, locate: function (t) {
                        ...
                        var e = t.coords.latitude, i = t.coords.longitude, o = new b.LatLng(e, i),
                            n = o.toBounds(t.coords.accuracy), r = this._locateOptions;
                        if (r.setView) {
                            var s = this.getBoundsZoom(n);
                            this.setView(o, r.maxZoom ? Math.min(s, r.maxZoom) : s)
                        }
                        var a = {latlng: o, bounds: n, timestamp: t.timestamp};
                ...
                !function (n, f) {
                    ...
                    function s(t, e, i) {
                        var o = "data-baron-" + e;
                        if ("on" == i) t.setAttribute(o, "inited"); else {
                    ...
                    if (n) {
                        ...
                        var c = function (t) {
                            ...
                            var a, l,
                                u = {outside: "", before: "", after: "", past: "", future: "", radius: 0, minView: 0},
                                c = [], h = [], d = [], o = this.scroller, p = this.event, _ = this.$, m = this;
                        ...
                        var h = function (e) {
                            ...
                            r = e.screen || .9, e.forward && (t = this.$(e.forward, this.clipper), this.event(t, "click", function () {
                                ...
                                var e = t["offset" + s.origin.x], i = s.bar[s.origin.offsetPos], o = 0;
                        ...
                        var d = function (a) {
                            ...
                            var i, h, d, o, p = this.$(a.block), _ = a.size || this.origin.size, m = a.limit || 80,
                                f = a.onExpand, g = a.elements || [], v = a.inProgress || "", y = this, b = 0, C = 0,
                                w = 0, x = a.waiting || 500;
    ...
    e.default = function () {
        !function (t, e, i, o) {
            try {
                var n = {element: document.querySelector(t), active: !1}, r = document.querySelector(e),
        ...
        !function () {
            ...
            try {
                var t = document.querySelectorAll(".diseasepage__trigger"),
                    ...
                    s = document.querySelector(".modal__info-img"), a = document.querySelector(".modal__info-text");
                t.forEach(function (t, e) {
                    t.addEventListener("click", function () {
