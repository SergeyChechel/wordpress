        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="contacts__map">
                        <?php echo do_shortcode('[yamap center="55.7358,37.5721" height="100%" controls="" zoom="12" type="yandex#map" scrollzoom="0" mobiledrag="0"][/yamap]')?>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?= do_shortcode('[contact-form-7 id="182" title="Форма отзывов"]'); ?>
